...
# Generated 2015-12-07 09:17:59.861580 by PyXB version 1.2.4 using Python 2.7.6.final.0
...
class CTD_ANON (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioSampleInfo.xsd', 19, 6)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://pacificbiosciences.com/PacBioSampleInfo.xsd}Barcode uses Python identifier Barcode
    __Barcode = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'Barcode'), 'Barcode', '__httppacificbiosciences_comPacBioSampleInfo_xsd_CTD_ANON_httppacificbiosciences_comPacBioSampleInfo_xsdBarcode', True, pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioSampleInfo.xsd', 21, 8), )
...
class CTD_ANON_2 (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioSampleInfo.xsd', 124, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
...
class BioSampleType (_ImportedBinding__pbbase.StrictEntityType):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioSampleInfo.xsd', 33, 1)
    ...
    __DateReceived._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioSampleInfo.xsd', 42, 4)
    __DateReceived._UseLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioSampleInfo.xsd', 42, 4)
    ...
    __Organism._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioSampleInfo.xsd', 47, 4)
    __Organism._UseLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioSampleInfo.xsd', 47, 4)
    ...
    __Reference._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioSampleInfo.xsd', 52, 4)
    __Reference._UseLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioSampleInfo.xsd', 52, 4)
    ...
    __DNAType._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioSampleInfo.xsd', 57, 4)
    __DNAType._UseLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioSampleInfo.xsd', 57, 4)
    ...
    __Concentration._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioSampleInfo.xsd', 62, 4)
    __Concentration._UseLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioSampleInfo.xsd', 62, 4)
    ...
    __QuantificationMethod._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioSampleInfo.xsd', 67, 4)
    __QuantificationMethod._UseLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioSampleInfo.xsd', 67, 4)
    ...
    __SMRTBellConcentration._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioSampleInfo.xsd', 72, 4)
    __SMRTBellConcentration._UseLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioSampleInfo.xsd', 72, 4)
    ...
    __SMRTBellQuantificationMethod._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioSampleInfo.xsd', 77, 4)
    __SMRTBellQuantificationMethod._UseLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioSampleInfo.xsd', 77, 4)
    ...
    __BufferName._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioSampleInfo.xsd', 82, 4)
    __BufferName._UseLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioSampleInfo.xsd', 82, 4)
    ...
    __SamplePrepKit._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioSampleInfo.xsd', 87, 4)
    __SamplePrepKit._UseLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioSampleInfo.xsd', 87, 4)
    ...
    __TargetLibrarySize._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioSampleInfo.xsd', 92, 4)
    __TargetLibrarySize._UseLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioSampleInfo.xsd', 92, 4)
...
class BarcodedSampleType (BioSampleType):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioSampleInfo.xsd', 8, 1)
...
BioSamplePointers = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'BioSamplePointers'), CTD_ANON_, documentation='Back references to other BarcodedSampleType object UniqueIds which utilize this sample', location=pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioSampleInfo.xsd', 100, 1))
Namespace.addCategoryObject('elementBinding', BioSamplePointers.name().localName(), BioSamplePointers)

BarcodedSamplePointers = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'BarcodedSamplePointers'), CTD_ANON_2, documentation='Back references to other BarcodedSampleType object UniqueIds which utilize this sample', location=pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioSampleInfo.xsd', 120, 1))
Namespace.addCategoryObject('elementBinding', BarcodedSamplePointers.name().localName(), BarcodedSamplePointers)

BioSamples = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'BioSamples'), CTD_ANON_3, location=pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioSampleInfo.xsd', 134, 1))
Namespace.addCategoryObject('elementBinding', BioSamples.name().localName(), BioSamples)

BioSample = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'BioSample'), BioSampleType, location=pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioSampleInfo.xsd', 141, 1))
Namespace.addCategoryObject('elementBinding', BioSample.name().localName(), BioSample)



CTD_ANON._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Barcode'), _ImportedBinding__pbbase.DNABarcode, scope=CTD_ANON, documentation='A sequence of barcodes associated with the biological sample', location=pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioSampleInfo.xsd', 21, 8)))
...
def _BuildAutomaton ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioSampleInfo.xsd', 21, 8))
    counters.add(cc_0)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Barcode')), pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioSampleInfo.xsd', 21, 8))
...
CTD_ANON_._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'BioSamplePointer'), pyxb.binding.datatypes.IDREF, scope=CTD_ANON_, documentation='Pointer to a single biological sample', location=pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioSampleInfo.xsd', 111, 5)))

CTD_ANON_._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'BarcodedSamplePointers'), CTD_ANON_2, scope=CTD_ANON_, documentation='Back references to other BarcodedSampleType object UniqueIds which utilize this sample', location=pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioSampleInfo.xsd', 120, 1)))
...
def _BuildAutomaton_ ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'BarcodedSamplePointers')), pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioSampleInfo.xsd', 110, 5))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'BioSamplePointer')), pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioSampleInfo.xsd', 111, 5))
...
CTD_ANON_2._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'BarcodedSamplePointer'), pyxb.binding.datatypes.IDREF, scope=CTD_ANON_2, documentation='Pointer to a group of barcoded samples', location=pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioSampleInfo.xsd', 126, 4)))
...
def _BuildAutomaton_2 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_2._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'BarcodedSamplePointer')), pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioSampleInfo.xsd', 126, 4))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
CTD_ANON_3._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'BioSample'), BioSampleType, scope=CTD_ANON_3, location=pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioSampleInfo.xsd', 141, 1)))
...
def _BuildAutomaton_3 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioSampleInfo.xsd', 137, 4))
    counters.add(cc_0)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_3._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'BioSample')), pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioSampleInfo.xsd', 137, 4))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
BioSampleType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'BioSamples'), CTD_ANON_3, scope=BioSampleType, location=pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioSampleInfo.xsd', 134, 1)))
...
def _BuildAutomaton_4 ():
    ...
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioSampleInfo.xsd', 40, 5))
    counters.add(cc_1)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(BioSampleType._UseForTag(pyxb.namespace.ExpandedName(_Namespace_pbbase, 'Extensions')), pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioBaseDataModel.xsd', 86, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(BioSampleType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'BioSamples')), pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioSampleInfo.xsd', 40, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
BarcodedSampleType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Barcodes'), CTD_ANON, scope=BarcodedSampleType, documentation='A list of barcodes associated with the biological sample', location=pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioSampleInfo.xsd', 15, 5)))
...
def _BuildAutomaton_5 ():
    ...
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioSampleInfo.xsd', 40, 5))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioSampleInfo.xsd', 15, 5))
    counters.add(cc_2)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(BarcodedSampleType._UseForTag(pyxb.namespace.ExpandedName(_Namespace_pbbase, 'Extensions')), pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioBaseDataModel.xsd', 86, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(BarcodedSampleType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'BioSamples')), pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioSampleInfo.xsd', 40, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(BarcodedSampleType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Barcodes')), pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioSampleInfo.xsd', 15, 5))
