...
# Generated 2015-12-07 09:17:59.863261 by PyXB version 1.2.4 using Python 2.7.6.final.0
...
class TubeLocation (pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 122, 1)
    _Documentation = None
...
class TubeSize (pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 128, 1)
    _Documentation = None
...
class ReagentKey (pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 134, 1)
    _Documentation = None
...
class CTD_ANON_ (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 70, 6)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://pacificbiosciences.com/PacBioReagentKit.xsd}Reagent uses Python identifier Reagent
    __Reagent = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'Reagent'), 'Reagent', '__httppacificbiosciences_comPacBioReagentKit_xsd_CTD_ANON__httppacificbiosciences_comPacBioReagentKit_xsdReagent', True, pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 17, 1), )
...
class ReagentType (_ImportedBinding__pbbase.BaseEntityType):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 54, 1)
    ...
    __ReagentKey._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 57, 4)
    __ReagentKey._UseLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 57, 4)
    ...
    __PlateColumn._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 58, 4)
    __PlateColumn._UseLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 58, 4)
    ...
    __Volume._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 59, 4)
    __Volume._UseLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 59, 4)
    ...
    __DeadVolume._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 60, 4)
    __DeadVolume._UseLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 60, 4)
    ...
    __ActiveInHour._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 61, 4)
    __ActiveInHour._UseLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 61, 4)
...
class ReagentKitType (_ImportedBinding__pbbase.BaseEntityType):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 65, 1)
    _ElementMap = _ImportedBinding__pbbase.BaseEntityType._ElementMap.copy()
    _AttributeMap = _ImportedBinding__pbbase.BaseEntityType._AttributeMap.copy()
    # Base type is _ImportedBinding__pbbase.BaseEntityType
    ...
    __ProductCode._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 92, 4)
    __ProductCode._UseLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 92, 4)
    ...
    __PlateType._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 93, 4)
    __PlateType._UseLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 93, 4)
    ...
    __ActiveInHour._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 94, 4)
    __ActiveInHour._UseLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 94, 4)
    ...
    __BasesPerSecond._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 95, 4)
    __BasesPerSecond._UseLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 95, 4)
    ...
    __AcquisitionCount._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 96, 4)
    __AcquisitionCount._UseLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 96, 4)
...
class ReagentTubeType (_ImportedBinding__pbbase.BaseEntityType):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 100, 1)
    _ElementMap = _ImportedBinding__pbbase.BaseEntityType._ElementMap.copy()
    _AttributeMap = _ImportedBinding__pbbase.BaseEntityType._AttributeMap.copy()
    # Base type is _ImportedBinding__pbbase.BaseEntityType
    ...
    __ProductCode._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 103, 4)
    __ProductCode._UseLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 103, 4)
    ...
    __ReagentKey._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 104, 4)
    __ReagentKey._UseLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 104, 4)
    ...
    __Volume._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 105, 4)
    __Volume._UseLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 105, 4)
    ...
    __DeadVolume._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 106, 4)
    __DeadVolume._UseLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 106, 4)
    ...
    __ActiveInHour._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 107, 4)
    __ActiveInHour._UseLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 107, 4)
    ...
    __TubeWellType._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 108, 4)
    __TubeWellType._UseLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 108, 4)
    ...
    __ReagentTubeType._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 109, 4)
    __ReagentTubeType._UseLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 109, 4)
    ...
    __InitialUse._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 110, 4)
    __InitialUse._UseLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 110, 4)
...
class ReagentPlateRowType (_ImportedBinding__pbbase.BaseEntityType):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 114, 1)
    _ElementMap = _ImportedBinding__pbbase.BaseEntityType._ElementMap.copy()
    _AttributeMap = _ImportedBinding__pbbase.BaseEntityType._AttributeMap.copy()
    # Base type is _ImportedBinding__pbbase.BaseEntityType
    ...
    __PlateRow._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 117, 4)
    __PlateRow._UseLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 117, 4)
    ...
    __InitialUse._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 118, 4)
    __InitialUse._UseLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 118, 4)
...
class SupplyKitSequencing (_ImportedBinding__pbbase.PartNumberType):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 21, 1)
    ...
    __Location._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 41, 4)
    __Location._UseLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 41, 4)
    ...
    __MaxCollections._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 46, 4)
    __MaxCollections._UseLocation = pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 46, 4)
...
PacBioReagentKit = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'PacBioReagentKit'), CTD_ANON, documentation='The root element of the reagent kit standalone file', location=pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 7, 1))
Namespace.addCategoryObject('elementBinding', PacBioReagentKit.name().localName(), PacBioReagentKit)

Reagent = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Reagent'), ReagentType, location=pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 17, 1))
Namespace.addCategoryObject('elementBinding', Reagent.name().localName(), Reagent)

ReagentKit = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ReagentKit'), ReagentKitType, location=pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 18, 1))
Namespace.addCategoryObject('elementBinding', ReagentKit.name().localName(), ReagentKit)

ReagentTube = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ReagentTube'), ReagentTubeType, location=pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 19, 1))
Namespace.addCategoryObject('elementBinding', ReagentTube.name().localName(), ReagentTube)

ReagentPlateRow = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ReagentPlateRow'), ReagentPlateRowType, location=pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 20, 1))
Namespace.addCategoryObject('elementBinding', ReagentPlateRow.name().localName(), ReagentPlateRow)



CTD_ANON._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ReagentKit'), ReagentKitType, scope=CTD_ANON, location=pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 18, 1)))
...
def _BuildAutomaton ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'ReagentKit')), pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 13, 4))
...
CTD_ANON_._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Reagent'), ReagentType, scope=CTD_ANON_, location=pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 17, 1)))
...
def _BuildAutomaton_ ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Reagent')), pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 72, 8))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
...
CTD_ANON_2._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ReagentTube'), ReagentTubeType, scope=CTD_ANON_2, location=pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 19, 1)))
...
def _BuildAutomaton_2 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_2._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'ReagentTube')), pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 79, 8))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
CTD_ANON_3._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ReagentPlateRow'), ReagentPlateRowType, scope=CTD_ANON_3, location=pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 20, 1)))
...
def _BuildAutomaton_3 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_3._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'ReagentPlateRow')), pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 86, 8))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
def _BuildAutomaton_4 ():
    ...
    symbol = pyxb.binding.content.ElementUse(ReagentType._UseForTag(pyxb.namespace.ExpandedName(_Namespace_pbbase, 'Extensions')), pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioBaseDataModel.xsd', 86, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
ReagentKitType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(_Namespace_pbbase, 'ChemistryConfig'), _ImportedBinding__pbbase.SequencingChemistryConfig, scope=ReagentKitType, location=pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioBaseDataModel.xsd', 797, 1)))

ReagentKitType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Reagents'), CTD_ANON_, scope=ReagentKitType, location=pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 69, 5)))

ReagentKitType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ReagentTubes'), CTD_ANON_2, scope=ReagentKitType, location=pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 76, 5)))

ReagentKitType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ReagentPlateRows'), CTD_ANON_3, scope=ReagentKitType, location=pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 83, 5)))
...
def _BuildAutomaton_5 ():
    ...
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(ReagentKitType._UseForTag(pyxb.namespace.ExpandedName(_Namespace_pbbase, 'Extensions')), pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioBaseDataModel.xsd', 86, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(ReagentKitType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Reagents')), pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 69, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(ReagentKitType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'ReagentTubes')), pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 76, 5))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(ReagentKitType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'ReagentPlateRows')), pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 83, 5))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(ReagentKitType._UseForTag(pyxb.namespace.ExpandedName(_Namespace_pbbase, 'ChemistryConfig')), pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 90, 5))
...
def _BuildAutomaton_6 ():
    ...
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(ReagentTubeType._UseForTag(pyxb.namespace.ExpandedName(_Namespace_pbbase, 'Extensions')), pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioBaseDataModel.xsd', 86, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
def _BuildAutomaton_7 ():
    ...
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(ReagentPlateRowType._UseForTag(pyxb.namespace.ExpandedName(_Namespace_pbbase, 'Extensions')), pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioBaseDataModel.xsd', 86, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
SupplyKitSequencing._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ReagentAutomationName'), pyxb.binding.datatypes.string, scope=SupplyKitSequencing, documentation='The reagent-mixing protocol used. ', location=pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 28, 5)))

SupplyKitSequencing._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ReagentTubes'), SupplyKitSequencing, scope=SupplyKitSequencing, documentation="Tubes associated with the reagent kit - can have up to two; don't forget to set the location, 0 or 1", location=pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 33, 5)))

SupplyKitSequencing._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'SequencingChemistry'), _ImportedBinding__pbbase.SequencingChemistry, scope=SupplyKitSequencing, location=pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 38, 5)))

SupplyKitSequencing._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'SequencingKitDefinition'), ReagentKitType, scope=SupplyKitSequencing, location=pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 39, 5)))
...
def _BuildAutomaton_8 ():
    ...
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 28, 5))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=2, metadata=pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 33, 5))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 38, 5))
    counters.add(cc_5)
    cc_6 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 39, 5))
    counters.add(cc_6)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(SupplyKitSequencing._UseForTag(pyxb.namespace.ExpandedName(_Namespace_pbbase, 'Extensions')), pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioBaseDataModel.xsd', 86, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(SupplyKitSequencing._UseForTag(pyxb.namespace.ExpandedName(_Namespace_pbbase, 'EncodedValue')), pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioBaseDataModel.xsd', 188, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(SupplyKitSequencing._UseForTag(pyxb.namespace.ExpandedName(_Namespace_pbbase, 'CheckSum')), pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioBaseDataModel.xsd', 193, 5))
    st_2 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(SupplyKitSequencing._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'ReagentAutomationName')), pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 28, 5))
    st_3 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(SupplyKitSequencing._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'ReagentTubes')), pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 33, 5))
    st_4 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_5, False))
    symbol = pyxb.binding.content.ElementUse(SupplyKitSequencing._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'SequencingChemistry')), pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 38, 5))
    st_5 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_6, False))
    symbol = pyxb.binding.content.ElementUse(SupplyKitSequencing._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'SequencingKitDefinition')), pyxb.utils.utility.Location('/tmp/tmpxjUNtlxsds/PacBioReagentKit.xsd', 39, 5))
