...
# Generated 2016-12-06 17:03:07.553198 by PyXB version 1.2.4 using Python 2.7.9.final.0
...
class PartTypes (pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmpiTHi4xxsds/PacBioPartNumbers.xsd', 28, 1)
    _Documentation = None
...
class PacBioPartNumbersType (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmpiTHi4xxsds/PacBioPartNumbers.xsd', 40, 1)
    _ElementMap = {}
    _AttributeMap = {}
...
class CTD_ANON_6 (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmpiTHi4xxsds/PacBioPartNumbers.xsd', 104, 4)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://pacificbiosciences.com/PacBioPartNumbers.xsd}OtherKit uses Python identifier OtherKit
    __OtherKit = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'OtherKit'), 'OtherKit', '__httppacificbiosciences_comPacBioPartNumbers_xsd_CTD_ANON_6_httppacificbiosciences_comPacBioPartNumbers_xsdOtherKit', True, pyxb.utils.utility.Location('/tmp/tmpiTHi4xxsds/PacBioPartNumbers.xsd', 19, 1), )
...
class CTD_ANON_8 (_ImportedBinding__pbbase.PartNumberType):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmpiTHi4xxsds/PacBioPartNumbers.xsd', 20, 2)
    ...
    __MaxCollections._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpiTHi4xxsds/PacBioPartNumbers.xsd', 23, 5)
    __MaxCollections._UseLocation = pyxb.utils.utility.Location('/tmp/tmpiTHi4xxsds/PacBioPartNumbers.xsd', 23, 5)
...
PacBioPartNumbers = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'PacBioPartNumbers'), PacBioPartNumbersType, documentation='The root element of the Part Numbers ', location=pyxb.utils.utility.Location('/tmp/tmpiTHi4xxsds/PacBioPartNumbers.xsd', 9, 1))
Namespace.addCategoryObject('elementBinding', PacBioPartNumbers.name().localName(), PacBioPartNumbers)

SequencingKit = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'SequencingKit'), _ImportedBinding__pbrk.SupplyKitSequencing, location=pyxb.utils.utility.Location('/tmp/tmpiTHi4xxsds/PacBioPartNumbers.xsd', 14, 1))
Namespace.addCategoryObject('elementBinding', SequencingKit.name().localName(), SequencingKit)

BindingKit = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'BindingKit'), _ImportedBinding__pbbase.SupplyKitBinding, location=pyxb.utils.utility.Location('/tmp/tmpiTHi4xxsds/PacBioPartNumbers.xsd', 15, 1))
Namespace.addCategoryObject('elementBinding', BindingKit.name().localName(), BindingKit)

TemplatePrepKit = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'TemplatePrepKit'), _ImportedBinding__pbbase.SupplyKitTemplate, location=pyxb.utils.utility.Location('/tmp/tmpiTHi4xxsds/PacBioPartNumbers.xsd', 16, 1))
Namespace.addCategoryObject('elementBinding', TemplatePrepKit.name().localName(), TemplatePrepKit)

ControlKit = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ControlKit'), _ImportedBinding__pbbase.SupplyKitControl, location=pyxb.utils.utility.Location('/tmp/tmpiTHi4xxsds/PacBioPartNumbers.xsd', 17, 1))
Namespace.addCategoryObject('elementBinding', ControlKit.name().localName(), ControlKit)

CellPackKit = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'CellPackKit'), _ImportedBinding__pbbase.SupplyKitCellPack, location=pyxb.utils.utility.Location('/tmp/tmpiTHi4xxsds/PacBioPartNumbers.xsd', 18, 1))
Namespace.addCategoryObject('elementBinding', CellPackKit.name().localName(), CellPackKit)

OtherKit = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'OtherKit'), CTD_ANON_8, location=pyxb.utils.utility.Location('/tmp/tmpiTHi4xxsds/PacBioPartNumbers.xsd', 19, 1))
Namespace.addCategoryObject('elementBinding', OtherKit.name().localName(), OtherKit)



PacBioPartNumbersType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(_Namespace_pbbase, 'KeyValueMap'), _ImportedBinding__pbbase.CTD_ANON_18, scope=PacBioPartNumbersType, location=pyxb.utils.utility.Location('/tmp/tmpiTHi4xxsds/PacBioBaseDataModel.xsd', 846, 1)))

PacBioPartNumbersType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Automations'), CTD_ANON, scope=PacBioPartNumbersType, location=pyxb.utils.utility.Location('/tmp/tmpiTHi4xxsds/PacBioPartNumbers.xsd', 43, 3)))

PacBioPartNumbersType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'BindingKits'), CTD_ANON_, scope=PacBioPartNumbersType, documentation='List the binding kit part numbers.  A list of incompatible part numbers and automations is available to specify in the PartNumber subtype.', location=pyxb.utils.utility.Location('/tmp/tmpiTHi4xxsds/PacBioPartNumbers.xsd', 50, 3)))

PacBioPartNumbersType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'TemplatePrepKits'), CTD_ANON_2, scope=PacBioPartNumbersType, documentation='List the sample prep kit part numbers.  A list of incompatible part numbers and automations is available to specify in the PartNumber subtype.', location=pyxb.utils.utility.Location('/tmp/tmpiTHi4xxsds/PacBioPartNumbers.xsd', 60, 3)))

PacBioPartNumbersType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'SequencingKits'), CTD_ANON_3, scope=PacBioPartNumbersType, documentation='List the sequencing kit part numbers.  A list of incompatible part numbers and automations is available to specify in the PartNumber subtype.', location=pyxb.utils.utility.Location('/tmp/tmpiTHi4xxsds/PacBioPartNumbers.xsd', 70, 3)))

PacBioPartNumbersType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ControlKits'), CTD_ANON_4, scope=PacBioPartNumbersType, documentation='List the DNA control complex part numbers.  A list of incompatible part numbers and automations is available to specify in the PartNumber subtype.', location=pyxb.utils.utility.Location('/tmp/tmpiTHi4xxsds/PacBioPartNumbers.xsd', 80, 3)))

PacBioPartNumbersType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'CellPackKits'), CTD_ANON_5, scope=PacBioPartNumbersType, documentation='List the cell tray part numbers.  A list of incompatible part numbers and automations is available to specify in the PartNumber subtype.', location=pyxb.utils.utility.Location('/tmp/tmpiTHi4xxsds/PacBioPartNumbers.xsd', 90, 3)))

PacBioPartNumbersType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'OtherKits'), CTD_ANON_6, scope=PacBioPartNumbersType, documentation='A placeholder for miscellaneous parts, such as OS Enzyme tubes', location=pyxb.utils.utility.Location('/tmp/tmpiTHi4xxsds/PacBioPartNumbers.xsd', 100, 3)))

PacBioPartNumbersType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'IncompatibleParts'), CTD_ANON_7, scope=PacBioPartNumbersType, location=pyxb.utils.utility.Location('/tmp/tmpiTHi4xxsds/PacBioPartNumbers.xsd', 110, 3)))
...
def _BuildAutomaton ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpiTHi4xxsds/PacBioPartNumbers.xsd', 43, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpiTHi4xxsds/PacBioPartNumbers.xsd', 50, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpiTHi4xxsds/PacBioPartNumbers.xsd', 60, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpiTHi4xxsds/PacBioPartNumbers.xsd', 70, 3))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpiTHi4xxsds/PacBioPartNumbers.xsd', 80, 3))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpiTHi4xxsds/PacBioPartNumbers.xsd', 90, 3))
    counters.add(cc_5)
    cc_6 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpiTHi4xxsds/PacBioPartNumbers.xsd', 100, 3))
    counters.add(cc_6)
    cc_7 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpiTHi4xxsds/PacBioPartNumbers.xsd', 110, 3))
    counters.add(cc_7)
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(PacBioPartNumbersType._UseForTag(pyxb.namespace.ExpandedName(_Namespace_pbbase, 'KeyValueMap')), pyxb.utils.utility.Location('/tmp/tmpiTHi4xxsds/PacBioPartNumbers.xsd', 42, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(PacBioPartNumbersType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Automations')), pyxb.utils.utility.Location('/tmp/tmpiTHi4xxsds/PacBioPartNumbers.xsd', 43, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(PacBioPartNumbersType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'BindingKits')), pyxb.utils.utility.Location('/tmp/tmpiTHi4xxsds/PacBioPartNumbers.xsd', 50, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(PacBioPartNumbersType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'TemplatePrepKits')), pyxb.utils.utility.Location('/tmp/tmpiTHi4xxsds/PacBioPartNumbers.xsd', 60, 3))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(PacBioPartNumbersType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'SequencingKits')), pyxb.utils.utility.Location('/tmp/tmpiTHi4xxsds/PacBioPartNumbers.xsd', 70, 3))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(PacBioPartNumbersType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'ControlKits')), pyxb.utils.utility.Location('/tmp/tmpiTHi4xxsds/PacBioPartNumbers.xsd', 80, 3))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_5, False))
    symbol = pyxb.binding.content.ElementUse(PacBioPartNumbersType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'CellPackKits')), pyxb.utils.utility.Location('/tmp/tmpiTHi4xxsds/PacBioPartNumbers.xsd', 90, 3))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_6, False))
    symbol = pyxb.binding.content.ElementUse(PacBioPartNumbersType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'OtherKits')), pyxb.utils.utility.Location('/tmp/tmpiTHi4xxsds/PacBioPartNumbers.xsd', 100, 3))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_7, False))
    symbol = pyxb.binding.content.ElementUse(PacBioPartNumbersType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'IncompatibleParts')), pyxb.utils.utility.Location('/tmp/tmpiTHi4xxsds/PacBioPartNumbers.xsd', 110, 3))
...
CTD_ANON._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Automation'), _ImportedBinding__pbbase.AutomationType, scope=CTD_ANON, location=pyxb.utils.utility.Location('/tmp/tmpiTHi4xxsds/PacBioPartNumbers.xsd', 46, 6)))
...
def _BuildAutomaton_ ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Automation')), pyxb.utils.utility.Location('/tmp/tmpiTHi4xxsds/PacBioPartNumbers.xsd', 46, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
...
CTD_ANON_._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'BindingKit'), _ImportedBinding__pbbase.SupplyKitBinding, scope=CTD_ANON_, location=pyxb.utils.utility.Location('/tmp/tmpiTHi4xxsds/PacBioPartNumbers.xsd', 15, 1)))
...
def _BuildAutomaton_2 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'BindingKit')), pyxb.utils.utility.Location('/tmp/tmpiTHi4xxsds/PacBioPartNumbers.xsd', 56, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
CTD_ANON_2._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'TemplatePrepKit'), _ImportedBinding__pbbase.SupplyKitTemplate, scope=CTD_ANON_2, location=pyxb.utils.utility.Location('/tmp/tmpiTHi4xxsds/PacBioPartNumbers.xsd', 16, 1)))
...
def _BuildAutomaton_3 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_2._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'TemplatePrepKit')), pyxb.utils.utility.Location('/tmp/tmpiTHi4xxsds/PacBioPartNumbers.xsd', 66, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
CTD_ANON_3._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'SequencingKit'), _ImportedBinding__pbrk.SupplyKitSequencing, scope=CTD_ANON_3, location=pyxb.utils.utility.Location('/tmp/tmpiTHi4xxsds/PacBioPartNumbers.xsd', 14, 1)))
...
def _BuildAutomaton_4 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_3._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'SequencingKit')), pyxb.utils.utility.Location('/tmp/tmpiTHi4xxsds/PacBioPartNumbers.xsd', 76, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
CTD_ANON_4._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ControlKit'), _ImportedBinding__pbbase.SupplyKitControl, scope=CTD_ANON_4, location=pyxb.utils.utility.Location('/tmp/tmpiTHi4xxsds/PacBioPartNumbers.xsd', 17, 1)))
...
def _BuildAutomaton_5 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_4._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'ControlKit')), pyxb.utils.utility.Location('/tmp/tmpiTHi4xxsds/PacBioPartNumbers.xsd', 86, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
CTD_ANON_5._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'CellPackKit'), _ImportedBinding__pbbase.SupplyKitCellPack, scope=CTD_ANON_5, location=pyxb.utils.utility.Location('/tmp/tmpiTHi4xxsds/PacBioPartNumbers.xsd', 18, 1)))
...
def _BuildAutomaton_6 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_5._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'CellPackKit')), pyxb.utils.utility.Location('/tmp/tmpiTHi4xxsds/PacBioPartNumbers.xsd', 96, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
CTD_ANON_6._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'OtherKit'), CTD_ANON_8, scope=CTD_ANON_6, location=pyxb.utils.utility.Location('/tmp/tmpiTHi4xxsds/PacBioPartNumbers.xsd', 19, 1)))
...
def _BuildAutomaton_7 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_6._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'OtherKit')), pyxb.utils.utility.Location('/tmp/tmpiTHi4xxsds/PacBioPartNumbers.xsd', 106, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
CTD_ANON_7._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'IncompatiblePart'), _ImportedBinding__pbbase.IncompatiblePairType, scope=CTD_ANON_7, location=pyxb.utils.utility.Location('/tmp/tmpiTHi4xxsds/PacBioPartNumbers.xsd', 113, 6)))
...
def _BuildAutomaton_8 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_7._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'IncompatiblePart')), pyxb.utils.utility.Location('/tmp/tmpiTHi4xxsds/PacBioPartNumbers.xsd', 113, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
def _BuildAutomaton_9 ():
    ...
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_8._UseForTag(pyxb.namespace.ExpandedName(_Namespace_pbbase, 'CheckSum')), pyxb.utils.utility.Location('/tmp/tmpiTHi4xxsds/PacBioBaseDataModel.xsd', 193, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_8._UseForTag(pyxb.namespace.ExpandedName(_Namespace_pbbase, 'Defaults')), pyxb.utils.utility.Location('/tmp/tmpiTHi4xxsds/PacBioBaseDataModel.xsd', 418, 5))
