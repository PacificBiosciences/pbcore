...
# Generated 2018-09-28 10:06:49.286460 by PyXB version 1.2.4 using Python 2.7.9.final.0
...
class TubeLocation (pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 162, 1)
    _Documentation = None
...
class TubeSize (pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 168, 1)
    _Documentation = None
...
class ReagentKey (pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 174, 1)
    _Documentation = None
...
class CTD_ANON_ (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 96, 6)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://pacificbiosciences.com/PacBioReagentKit.xsd}Reagent uses Python identifier Reagent
    __Reagent = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'Reagent'), 'Reagent', '__httppacificbiosciences_comPacBioReagentKit_xsd_CTD_ANON__httppacificbiosciences_comPacBioReagentKit_xsdReagent', True, pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 17, 1), )
...
class ReagentType (_ImportedBinding__pbbase.BaseEntityType):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 79, 1)
    ...
    __ReagentKey._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 82, 4)
    __ReagentKey._UseLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 82, 4)
    ...
    __PlateColumn._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 83, 4)
    __PlateColumn._UseLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 83, 4)
    ...
    __Volume._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 84, 4)
    __Volume._UseLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 84, 4)
    ...
    __DeadVolume._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 85, 4)
    __DeadVolume._UseLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 85, 4)
    ...
    __ActiveInHour._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 86, 4)
    __ActiveInHour._UseLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 86, 4)
    ...
    __Rows._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 87, 5)
    __Rows._UseLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 87, 5)
...
class ReagentKitType (_ImportedBinding__pbbase.BaseEntityType):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 91, 1)
    _ElementMap = _ImportedBinding__pbbase.BaseEntityType._ElementMap.copy()
    _AttributeMap = _ImportedBinding__pbbase.BaseEntityType._AttributeMap.copy()
    # Base type is _ImportedBinding__pbbase.BaseEntityType
    ...
    __ProductCode._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 129, 4)
    __ProductCode._UseLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 129, 4)
    ...
    __PlateType._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 130, 4)
    __PlateType._UseLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 130, 4)
    ...
    __ActiveInHour._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 131, 4)
    __ActiveInHour._UseLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 131, 4)
    ...
    __BasesPerSecond._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 132, 4)
    __BasesPerSecond._UseLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 132, 4)
    ...
    __AcquisitionCount._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 133, 4)
    __AcquisitionCount._UseLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 133, 4)
...
class ReagentTubeType (_ImportedBinding__pbbase.BaseEntityType):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 137, 1)
    _ElementMap = _ImportedBinding__pbbase.BaseEntityType._ElementMap.copy()
    _AttributeMap = _ImportedBinding__pbbase.BaseEntityType._AttributeMap.copy()
    # Base type is _ImportedBinding__pbbase.BaseEntityType
    ...
    __ProductCode._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 140, 4)
    __ProductCode._UseLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 140, 4)
    ...
    __ReagentKey._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 141, 4)
    __ReagentKey._UseLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 141, 4)
    ...
    __Volume._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 142, 4)
    __Volume._UseLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 142, 4)
    ...
    __UsageVolume._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 143, 4)
    __UsageVolume._UseLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 143, 4)
    ...
    __UsageKey._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 144, 4)
    __UsageKey._UseLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 144, 4)
    ...
    __DeadVolume._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 145, 4)
    __DeadVolume._UseLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 145, 4)
    ...
    __ActiveInHour._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 146, 4)
    __ActiveInHour._UseLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 146, 4)
    ...
    __TubeWellType._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 147, 4)
    __TubeWellType._UseLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 147, 4)
    ...
    __ReagentTubeType._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 148, 4)
    __ReagentTubeType._UseLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 148, 4)
    ...
    __InitialUse._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 149, 4)
    __InitialUse._UseLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 149, 4)
...
class ReagentPlateRowType (_ImportedBinding__pbbase.BaseEntityType):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 153, 1)
    _ElementMap = _ImportedBinding__pbbase.BaseEntityType._ElementMap.copy()
    _AttributeMap = _ImportedBinding__pbbase.BaseEntityType._AttributeMap.copy()
    # Base type is _ImportedBinding__pbbase.BaseEntityType
    ...
    __PlateRow._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 156, 4)
    __PlateRow._UseLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 156, 4)
    ...
    __InitialUse._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 157, 4)
    __InitialUse._UseLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 157, 4)
    ...
    __Reaction._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 158, 5)
    __Reaction._UseLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 158, 5)
...
class SupplyKitSequencing (_ImportedBinding__pbbase.PartNumberType):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 21, 1)
    ...
    __Location._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 41, 4)
    __Location._UseLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 41, 4)
    ...
    __MaxCollections._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 46, 4)
    __MaxCollections._UseLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 46, 4)
    ...
    __ActiveHours._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 51, 4)
    __ActiveHours._UseLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 51, 4)
    ...
    __ActiveHoursLimit._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 56, 4)
    __ActiveHoursLimit._UseLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 56, 4)
    ...
    __MaxRunHours._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 61, 8)
    __MaxRunHours._UseLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 61, 8)
    ...
    __NumOilTubes._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 66, 8)
    __NumOilTubes._UseLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 66, 8)
    ...
    __NumOseTubes._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 71, 5)
    __NumOseTubes._UseLocation = pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 71, 5)
...
PacBioReagentKit = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'PacBioReagentKit'), CTD_ANON, documentation='The root element of the reagent kit standalone file', location=pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 7, 1))
Namespace.addCategoryObject('elementBinding', PacBioReagentKit.name().localName(), PacBioReagentKit)

Reagent = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Reagent'), ReagentType, location=pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 17, 1))
Namespace.addCategoryObject('elementBinding', Reagent.name().localName(), Reagent)

ReagentKit = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ReagentKit'), ReagentKitType, location=pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 18, 1))
Namespace.addCategoryObject('elementBinding', ReagentKit.name().localName(), ReagentKit)

ReagentTube = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ReagentTube'), ReagentTubeType, location=pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 19, 1))
Namespace.addCategoryObject('elementBinding', ReagentTube.name().localName(), ReagentTube)

ReagentPlateRow = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ReagentPlateRow'), ReagentPlateRowType, location=pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 20, 1))
Namespace.addCategoryObject('elementBinding', ReagentPlateRow.name().localName(), ReagentPlateRow)



CTD_ANON._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ReagentKit'), ReagentKitType, scope=CTD_ANON, location=pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 18, 1)))
...
def _BuildAutomaton ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'ReagentKit')), pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 13, 4))
...
CTD_ANON_._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Reagent'), ReagentType, scope=CTD_ANON_, location=pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 17, 1)))
...
def _BuildAutomaton_ ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Reagent')), pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 98, 8))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
...
CTD_ANON_2._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ReagentTube'), ReagentTubeType, scope=CTD_ANON_2, location=pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 19, 1)))
...
def _BuildAutomaton_2 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_2._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'ReagentTube')), pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 105, 8))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
CTD_ANON_3._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ReagentPlateRow'), ReagentPlateRowType, scope=CTD_ANON_3, location=pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 20, 1)))
...
def _BuildAutomaton_3 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_3._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'ReagentPlateRow')), pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 112, 8))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
CTD_ANON_4._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Automation'), _ImportedBinding__pbbase.AutomationType, scope=CTD_ANON_4, location=pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 124, 8)))
...
def _BuildAutomaton_4 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_4._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Automation')), pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 124, 8))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
def _BuildAutomaton_5 ():
    ...
    symbol = pyxb.binding.content.ElementUse(ReagentType._UseForTag(pyxb.namespace.ExpandedName(_Namespace_pbbase, 'Extensions')), pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioBaseDataModel.xsd', 98, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
ReagentKitType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(_Namespace_pbbase, 'ChemistryConfig'), _ImportedBinding__pbbase.SequencingChemistryConfig, scope=ReagentKitType, location=pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioBaseDataModel.xsd', 1016, 1)))
...
ReagentKitType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Reagents'), CTD_ANON_, scope=ReagentKitType, location=pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 95, 5)))

ReagentKitType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ReagentTubes'), CTD_ANON_2, scope=ReagentKitType, location=pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 102, 5)))

ReagentKitType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ReagentPlateRows'), CTD_ANON_3, scope=ReagentKitType, location=pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 109, 5)))

ReagentKitType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Automations'), CTD_ANON_4, nillable=pyxb.binding.datatypes.boolean(1), scope=ReagentKitType, documentation='Automations that are deemed compatible with this kit.  Parameters specified within an automation will override a parameter with the same name and data type specified in the above Defaults section', location=pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 118, 5)))
...
def _BuildAutomaton_6 ():
    ...
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioBaseDataModel.xsd', 98, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 117, 5))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 118, 5))
    counters.add(cc_2)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(ReagentKitType._UseForTag(pyxb.namespace.ExpandedName(_Namespace_pbbase, 'Extensions')), pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioBaseDataModel.xsd', 98, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(ReagentKitType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Reagents')), pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 95, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(ReagentKitType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'ReagentTubes')), pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 102, 5))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(ReagentKitType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'ReagentPlateRows')), pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 109, 5))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(ReagentKitType._UseForTag(pyxb.namespace.ExpandedName(_Namespace_pbbase, 'ChemistryConfig')), pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 116, 5))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(ReagentKitType._UseForTag(pyxb.namespace.ExpandedName(_Namespace_pbbase, 'Defaults')), pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 117, 5))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(ReagentKitType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Automations')), pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 118, 5))
...
def _BuildAutomaton_7 ():
    ...
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(ReagentTubeType._UseForTag(pyxb.namespace.ExpandedName(_Namespace_pbbase, 'Extensions')), pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioBaseDataModel.xsd', 98, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
def _BuildAutomaton_8 ():
    ...
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(ReagentPlateRowType._UseForTag(pyxb.namespace.ExpandedName(_Namespace_pbbase, 'Extensions')), pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioBaseDataModel.xsd', 98, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
SupplyKitSequencing._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ReagentAutomationName'), pyxb.binding.datatypes.string, scope=SupplyKitSequencing, documentation='The reagent-mixing protocol used. ', location=pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 28, 5)))

SupplyKitSequencing._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ReagentTubes'), SupplyKitSequencing, scope=SupplyKitSequencing, documentation="Tubes associated with the reagent kit - can have up to two; don't forget to set the location, 0 or 1", location=pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 33, 5)))

SupplyKitSequencing._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'SequencingChemistry'), _ImportedBinding__pbbase.SequencingChemistry, scope=SupplyKitSequencing, location=pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 38, 5)))

SupplyKitSequencing._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'SequencingKitDefinition'), ReagentKitType, scope=SupplyKitSequencing, location=pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 39, 5)))
...
def _BuildAutomaton_9 ():
    ...
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 28, 5))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=2, metadata=pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 33, 5))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 38, 5))
    counters.add(cc_5)
    cc_6 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 39, 5))
    counters.add(cc_6)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(SupplyKitSequencing._UseForTag(pyxb.namespace.ExpandedName(_Namespace_pbbase, 'Extensions')), pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioBaseDataModel.xsd', 98, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(SupplyKitSequencing._UseForTag(pyxb.namespace.ExpandedName(_Namespace_pbbase, 'CheckSum')), pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioBaseDataModel.xsd', 206, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(SupplyKitSequencing._UseForTag(pyxb.namespace.ExpandedName(_Namespace_pbbase, 'Defaults')), pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioBaseDataModel.xsd', 452, 5))
    st_2 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(SupplyKitSequencing._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'ReagentAutomationName')), pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 28, 5))
    st_3 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(SupplyKitSequencing._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'ReagentTubes')), pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 33, 5))
    st_4 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_5, False))
    symbol = pyxb.binding.content.ElementUse(SupplyKitSequencing._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'SequencingChemistry')), pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 38, 5))
    st_5 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_6, False))
    symbol = pyxb.binding.content.ElementUse(SupplyKitSequencing._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'SequencingKitDefinition')), pyxb.utils.utility.Location('/tmp/tmpcx2T3Lxsds/PacBioReagentKit.xsd', 39, 5))
