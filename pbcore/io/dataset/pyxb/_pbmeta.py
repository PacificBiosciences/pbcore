...
# Generated 2019-01-28 12:04:04.089208 by PyXB version 1.2.4 using Python 2.7.14.final.0
...
class STD_ANON (pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 440, 8)
    _Documentation = None
...
class STD_ANON_ (pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 452, 8)
    _Documentation = None
...
class STD_ANON_2 (pyxb.binding.datatypes.string):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 470, 11)
    _Documentation = None
...
class STD_ANON_3 (pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 480, 11)
    _Documentation = None
...
class PapOutputFile (pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 574, 1)
...
class CTD_ANON (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 14, 2)
    _ElementMap = {}
    _AttributeMap = {}
...
class CTD_ANON_ (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 24, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://pacificbiosciences.com/PacBioCollectionMetadata.xsd}CollectionMetadata uses Python identifier CollectionMetadata
    __CollectionMetadata = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'CollectionMetadata'), 'CollectionMetadata', '__httppacificbiosciences_comPacBioCollectionMetadata_xsd_CTD_ANON__httppacificbiosciences_comPacBioCollectionMetadata_xsdCollectionMetadata', True, pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 30, 1), )
...
class CTD_ANON_5 (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 252, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
...
class CTD_ANON_7 (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 382, 5)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
...
class CTD_ANON_9 (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 426, 8)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
...
class CTD_ANON_11 (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 522, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://pacificbiosciences.com/PacBioCollectionMetadata.xsd}AutomationName uses Python identifier AutomationName
    __AutomationName = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'AutomationName'), 'AutomationName', '__httppacificbiosciences_comPacBioCollectionMetadata_xsd_CTD_ANON_11_httppacificbiosciences_comPacBioCollectionMetadata_xsdAutomationName', False, pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 524, 4), )
...
class CTD_ANON_12 (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 533, 5)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
...
class CTD_ANON_13 (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 561, 2)
    _ElementMap = {}
    _AttributeMap = {}
    ...
    __key._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 564, 5)
    __key._UseLocation = pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 564, 5)
    ...
    __label._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 569, 5)
    __label._UseLocation = pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 569, 5)
...
class CTD_ANON_14 (_ImportedBinding__pbbase.BaseEntityType):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 296, 2)
...
class CTD_ANON_15 (_ImportedBinding__pbbase.StrictEntityType):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 34, 2)
    ...
    __Context._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 160, 5)
    __Context._UseLocation = pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 160, 5)
    ...
    __Status._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 165, 5)
    __Status._UseLocation = pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 165, 5)
    ...
    __InstrumentId._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 166, 5)
    __InstrumentId._UseLocation = pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 166, 5)
    ...
    __InstrumentName._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 171, 5)
    __InstrumentName._UseLocation = pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 171, 5)
...
PacBioCollectionMetadata = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'PacBioCollectionMetadata'), CTD_ANON, documentation='Root element of a standalone CollectionMetadata file.', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 10, 1))
Namespace.addCategoryObject('elementBinding', PacBioCollectionMetadata.name().localName(), PacBioCollectionMetadata)

Collections = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Collections'), CTD_ANON_, documentation='A set of acquisition definitions', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 20, 1))
Namespace.addCategoryObject('elementBinding', Collections.name().localName(), Collections)

RunDetails = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'RunDetails'), CTD_ANON_3, documentation='Information related to an instrument run.  A run can contain multiple chips, wells, and movies. ', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 180, 1))
Namespace.addCategoryObject('elementBinding', RunDetails.name().localName(), RunDetails)

Movie = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Movie'), CTD_ANON_4, documentation='A movie corresponds to one acquisition for a chip, one set (look) and one strobe. ', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 224, 1))
Namespace.addCategoryObject('elementBinding', Movie.name().localName(), Movie)

ExpirationData = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ExpirationData'), CTD_ANON_5, documentation='Container for the expired consumable data. ', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 248, 1))
Namespace.addCategoryObject('elementBinding', ExpirationData.name().localName(), ExpirationData)

Primary = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Primary'), CTD_ANON_6, documentation='Container for the primary analysis related data. ', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 372, 1))
Namespace.addCategoryObject('elementBinding', Primary.name().localName(), Primary)

Secondary = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Secondary'), CTD_ANON_11, documentation='Container for the primary analysis related data. ', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 518, 1))
Namespace.addCategoryObject('elementBinding', Secondary.name().localName(), Secondary)

UserDefinedFields = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'UserDefinedFields'), _ImportedBinding__pbbase.UserDefinedFieldsType, documentation='A set of key-value pairs specified by a user via the run input mechanism. Note that uniqueness of keys is not enforced here and so may contain duplicate keys. ', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 552, 1))
Namespace.addCategoryObject('elementBinding', UserDefinedFields.name().localName(), UserDefinedFields)

KeyValue = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'KeyValue'), CTD_ANON_13, documentation='One custom, possibly non-unique, key-value pair. ', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 557, 1))
Namespace.addCategoryObject('elementBinding', KeyValue.name().localName(), KeyValue)

WellSample = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'WellSample'), CTD_ANON_14, documentation='Container for the sample related data. ', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 292, 1))
Namespace.addCategoryObject('elementBinding', WellSample.name().localName(), WellSample)

CollectionMetadata = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'CollectionMetadata'), CTD_ANON_15, documentation='Root-level element for the metadata.  The purpose of which is to contain pertinent instrument information related to the conditions present during a movie acquisition.  It also serves to provide key pieces of information for integration with primary and secondary analysis.  This file is associated with 1 movie. ', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 30, 1))
...
def _BuildAutomaton ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'CollectionMetadata')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 16, 4))
...
def _BuildAutomaton_ ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'CollectionMetadata')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 26, 4))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
...
CTD_ANON_2._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'VersionInfo'), _ImportedBinding__pbbase.BaseEntityType, scope=CTD_ANON_2, documentation='Each component should list its name and version attribute', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 151, 9)))
...
def _BuildAutomaton_2 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_2._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'VersionInfo')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 151, 9))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
CTD_ANON_3._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'TimeStampedName'), pyxb.binding.datatypes.string, scope=CTD_ANON_3, documentation='A unique identifier for this run.  Format is r[sid]_[iname]_[ts]. Where [id] is a system generated id and [iname] is the instrument name and [ts] is a timestamp YYMMDD Example:  r000123_00117_100713 ', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 186, 4)))

CTD_ANON_3._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Name'), pyxb.binding.datatypes.string, scope=CTD_ANON_3, documentation='Assigned name for a run, which consists of multiple wells. There is no constraint on the uniqueness of this data. ', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 191, 4)))

CTD_ANON_3._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'CreatedBy'), pyxb.binding.datatypes.string, scope=CTD_ANON_3, documentation='Who created the run. ', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 196, 4)))

CTD_ANON_3._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'WhenCreated'), pyxb.binding.datatypes.dateTime, scope=CTD_ANON_3, documentation='Date and time of when the overall run was created in the system. ', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 201, 4)))

CTD_ANON_3._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'StartedBy'), pyxb.binding.datatypes.string, scope=CTD_ANON_3, documentation='Who started the run. Could be different from who created it. ', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 206, 4)))

CTD_ANON_3._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'WhenStarted'), pyxb.binding.datatypes.dateTime, scope=CTD_ANON_3, documentation='Date and time of when the overall run was started. ', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 211, 4)))

CTD_ANON_3._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'WhenCompleted'), pyxb.binding.datatypes.dateTime, scope=CTD_ANON_3, documentation='Date and time of when the overall run was completed. ', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 216, 4)))
...
def _BuildAutomaton_3 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 191, 4))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 196, 4))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 201, 4))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 206, 4))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 211, 4))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 216, 4))
    counters.add(cc_5)
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_3._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'TimeStampedName')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 186, 4))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_3._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Name')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 191, 4))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_3._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'CreatedBy')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 196, 4))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_3._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'WhenCreated')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 201, 4))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_3._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'StartedBy')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 206, 4))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_3._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'WhenStarted')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 211, 4))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_5, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_3._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'WhenCompleted')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 216, 4))
...
CTD_ANON_4._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'WhenStarted'), pyxb.binding.datatypes.dateTime, scope=CTD_ANON_4, documentation='Date and time of when this movie acquisition started. ', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 230, 4)))

CTD_ANON_4._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'DurationInSec'), pyxb.binding.datatypes.int, scope=CTD_ANON_4, documentation='The actual length of the movie acquisition (in seconds), irrespective of the movie duration specified by an automation parameter. ', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 235, 4), unicode_default='0'))

CTD_ANON_4._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Number'), pyxb.binding.datatypes.int, scope=CTD_ANON_4, documentation="The number of this movie within the set (i.e., look).  This is unique when combined with the 'SetNumber'. ", location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 240, 4), unicode_default='0'))
...
def _BuildAutomaton_4 ():
    ...
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_4._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'WhenStarted')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 230, 4))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_4._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'DurationInSec')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 235, 4))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_4._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Number')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 240, 4))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    transitions = []
    transitions.append(fac.Transition(st_1, [
...
CTD_ANON_5._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'TemplatePrepKitPastExpiration'), pyxb.binding.datatypes.int, scope=CTD_ANON_5, documentation='Number of days past expiration the template prep kit was (if at all). ', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 254, 4)))

CTD_ANON_5._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'BindingKitPastExpiration'), pyxb.binding.datatypes.int, scope=CTD_ANON_5, documentation='Number of days past expiration the binding kit was (if at all). ', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 259, 4)))

CTD_ANON_5._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'CellPacPastExpiration'), pyxb.binding.datatypes.int, scope=CTD_ANON_5, documentation='Number of days past expiration the cell pac was (if at all). ', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 264, 4)))

CTD_ANON_5._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'SequencingKitPastExpiration'), pyxb.binding.datatypes.int, scope=CTD_ANON_5, documentation='Number of days past expiration the reagent kit was (if at all). ', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 274, 4)))

CTD_ANON_5._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'SequencingTube0PastExpiration'), pyxb.binding.datatypes.int, scope=CTD_ANON_5, documentation='Number of days past expiration the reagent tube 0 was (if at all). ', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 279, 4)))

CTD_ANON_5._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'SequencingTube1PastExpiration'), pyxb.binding.datatypes.int, scope=CTD_ANON_5, documentation='Number of days past expiration the reagent tube 1 was (if at all). ', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 284, 4)))
...
def _BuildAutomaton_5 ():
    ...
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_5._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'TemplatePrepKitPastExpiration')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 254, 4))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_5._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'BindingKitPastExpiration')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 259, 4))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_5._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'CellPacPastExpiration')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 264, 4))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_5._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'CellPacPastExpiration')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 269, 4))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_5._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'SequencingKitPastExpiration')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 274, 4))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_5._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'SequencingTube0PastExpiration')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 279, 4))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_5._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'SequencingTube1PastExpiration')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 284, 4))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    transitions = []
    transitions.append(fac.Transition(st_1, [
...
CTD_ANON_6._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'SampleTrace'), CTD_ANON_7, scope=CTD_ANON_6, documentation='Tag to indicate that the trace file will be sampled. ', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 378, 4)))

CTD_ANON_6._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'AutomationName'), pyxb.binding.datatypes.string, scope=CTD_ANON_6, documentation='Name of primary analysis protocol. ', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 397, 4)))

CTD_ANON_6._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ConfigFileName'), pyxb.binding.datatypes.string, scope=CTD_ANON_6, documentation='Name of primary analysis config file. ', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 402, 8)))

CTD_ANON_6._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'SequencingCondition'), pyxb.binding.datatypes.string, scope=CTD_ANON_6, documentation='A sequencing condition tag to be used by primary analysis, e.g., to select basecaller calibration or training parameters. ', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 407, 4)))

CTD_ANON_6._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'OutputOptions'), CTD_ANON_8, scope=CTD_ANON_6, location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 412, 4)))
...
def _BuildAutomaton_6 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 378, 4))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 402, 8))
    counters.add(cc_1)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_6._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'SampleTrace')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 378, 4))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_6._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'AutomationName')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 397, 4))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_6._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'ConfigFileName')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 402, 8))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_6._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'SequencingCondition')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 407, 4))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_6._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'OutputOptions')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 412, 4))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
CTD_ANON_7._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'TraceSamplingFactor'), pyxb.binding.datatypes.float, scope=CTD_ANON_7, documentation='Percentage of traces to sample. ', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 384, 7)))

CTD_ANON_7._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'FullPulseFile'), pyxb.binding.datatypes.boolean, scope=CTD_ANON_7, documentation='Whether full or sampled pulse file is transferred if requested. ', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 389, 7)))
...
def _BuildAutomaton_7 ():
    ...
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_7._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'TraceSamplingFactor')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 384, 7))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_7._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'FullPulseFile')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 389, 7))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    transitions = []
    transitions.append(fac.Transition(st_1, [
...
CTD_ANON_8._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ResultsFolder'), pyxb.binding.datatypes.string, scope=CTD_ANON_8, documentation="NOTE: not for customers. A sub-folder under the CollectionPath created by Primary Analysis. This is a field that will be updated by the primary analysis pipeline.  The default (as created by homer) should be set to 'Reports_Sms' for now.  Consumers of the data should be aware that they will find collection metadata (and trace files if acquisition is so-configured) at the CollectionPathUri, and all primary analysis results in the sub-folder PrimaryResultsFolder. ", location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 415, 7)))

CTD_ANON_8._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'CollectionPathUri'), pyxb.binding.datatypes.anyURI, scope=CTD_ANON_8, documentation='User-specified location of where the results should be copied after an analysis has been completed. ', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 420, 7)))

CTD_ANON_8._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'CopyFiles'), CTD_ANON_9, scope=CTD_ANON_8, location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 425, 7)))

CTD_ANON_8._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Readout'), STD_ANON, scope=CTD_ANON_8, documentation='BazIO Readout option; valid values are Bases (default) and Pulses', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 436, 7), unicode_default='Bases'))

CTD_ANON_8._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'MetricsVerbosity'), STD_ANON_, scope=CTD_ANON_8, documentation='BazIO MetricsVerbosity option; valid values are Minimal (default), High, and None', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 448, 7), unicode_default='Minimal'))

CTD_ANON_8._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'TransferResource'), CTD_ANON_10, scope=CTD_ANON_8, documentation='Transfer Resource (optional for now, but will be made required when ICS implements this)', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 460, 7)))
...
def _BuildAutomaton_8 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 460, 7))
    counters.add(cc_0)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_8._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'ResultsFolder')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 415, 7))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_8._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'CollectionPathUri')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 420, 7))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_8._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'CopyFiles')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 425, 7))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_8._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Readout')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 436, 7))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_8._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'MetricsVerbosity')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 448, 7))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_8._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'TransferResource')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 460, 7))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    transitions = []
    transitions.append(fac.Transition(st_1, [
...
def _BuildAutomaton_9 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_9._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'CollectionFileCopy')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 428, 10))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
CTD_ANON_10._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Id'), STD_ANON_2, scope=CTD_ANON_10, documentation='Id of the Transfer Resource that is unique to the Scheme Type. A tuple of (TransferScheme, Id) will be globally unique', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 466, 10)))

CTD_ANON_10._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'TransferScheme'), STD_ANON_3, scope=CTD_ANON_10, documentation='Transfer Scheme type (this should be an enum Scheme of rsync, srs or nfs)', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 476, 10)))

CTD_ANON_10._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Name'), pyxb.binding.datatypes.string, scope=CTD_ANON_10, documentation='Display Name of the Transfer Resource', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 488, 10)))

CTD_ANON_10._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Description'), pyxb.binding.datatypes.string, scope=CTD_ANON_10, documentation='Description of the Transfer Resource', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 493, 10)))

CTD_ANON_10._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'DestPath'), pyxb.binding.datatypes.string, scope=CTD_ANON_10, documentation='Remote Root Destination Path of the Transfer Resource', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 498, 10)))

CTD_ANON_10._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'RelativePath'), pyxb.binding.datatypes.string, scope=CTD_ANON_10, documentation='Remote Relative Path of the Transfer Resource', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 503, 10)))
...
def _BuildAutomaton_10 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 503, 10))
    counters.add(cc_0)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_10._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Id')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 466, 10))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_10._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'TransferScheme')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 476, 10))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_10._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Name')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 488, 10))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_10._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Description')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 493, 10))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_10._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'DestPath')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 498, 10))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_10._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'RelativePath')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 503, 10))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    transitions = []
    transitions.append(fac.Transition(st_1, [
...
CTD_ANON_11._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'AutomationName'), pyxb.binding.datatypes.string, scope=CTD_ANON_11, documentation='The secondary analysis protocol name specified in the sample sheet. Ignored by secondary. ', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 524, 4)))

CTD_ANON_11._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'AutomationParameters'), CTD_ANON_12, scope=CTD_ANON_11, documentation='The parameters for secondary analysis specified in the sample sheet. Ignored by secondary. ', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 529, 4)))

CTD_ANON_11._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'CellCountInJob'), pyxb.binding.datatypes.int, scope=CTD_ANON_11, documentation="The number of cells in this secondary analysis job, identified by the secondary analysis parameter 'JobName'.  Supports automated secondary analysis. ", location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 543, 4)))
...
def _BuildAutomaton_11 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 529, 4))
    counters.add(cc_0)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_11._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'AutomationName')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 524, 4))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_11._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'AutomationParameters')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 529, 4))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_11._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'CellCountInJob')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 543, 4))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    transitions = []
    transitions.append(fac.Transition(st_1, [
...
CTD_ANON_12._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'AutomationParameter'), _ImportedBinding__pbbase.DataEntityType, scope=CTD_ANON_12, documentation='One or more secondary analysis parameters, such as JobName, Workflow, etc..', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 535, 7)))
...
def _BuildAutomaton_12 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 535, 7))
    counters.add(cc_0)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_12._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'AutomationParameter')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 535, 7))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
CTD_ANON_14._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'WellName'), pyxb.binding.datatypes.string, scope=CTD_ANON_14, documentation='Identifies which well this sample came from (e.g., coordinate on a plate). ', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 300, 6)))

CTD_ANON_14._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Concentration'), pyxb.binding.datatypes.double, scope=CTD_ANON_14, documentation='Sample input concentration. ', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 305, 6)))

CTD_ANON_14._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'OnPlateLoadingConcentration'), pyxb.binding.datatypes.double, scope=CTD_ANON_14, documentation='On plate loading concentration. ', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 310, 24)))

CTD_ANON_14._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'InsertSize'), pyxb.binding.datatypes.int, scope=CTD_ANON_14, documentation='Length of the sheared template, e.g. 500, 2000, 30000', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 315, 6)))

CTD_ANON_14._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'IsoSeq'), pyxb.binding.datatypes.boolean, scope=CTD_ANON_14, documentation='Whether or not this is an Iso-Seq experiment (optional; defaults to false).', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 320, 6)))

CTD_ANON_14._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'LoadingTarget'), pyxb.binding.datatypes.double, scope=CTD_ANON_14, documentation='Dynamic Loading Target', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 325, 24)))

CTD_ANON_14._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'MaxLoadingTime'), pyxb.binding.datatypes.double, scope=CTD_ANON_14, documentation='Dynamic Loading Maximum Loading Time', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 330, 24)))

CTD_ANON_14._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'SampleReuseEnabled'), pyxb.binding.datatypes.boolean, scope=CTD_ANON_14, documentation='Whether or not complex reuse is enabled for this well. ', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 335, 6)))

CTD_ANON_14._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'StageHotstartEnabled'), pyxb.binding.datatypes.boolean, scope=CTD_ANON_14, documentation='Whether or not hotstart at the stage is enabled for this well. ', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 340, 6)))

CTD_ANON_14._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'SizeSelectionEnabled'), pyxb.binding.datatypes.boolean, scope=CTD_ANON_14, documentation='Whether or not size selection is enabled for this well. ', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 345, 6)))

CTD_ANON_14._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'UseCount'), pyxb.binding.datatypes.int, scope=CTD_ANON_14, documentation='Count of usages for this batch of complex. ', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 350, 6)))

CTD_ANON_14._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'DNAControlComplex'), pyxb.binding.datatypes.string, scope=CTD_ANON_14, documentation='Indicating what kind (if any) control was used. ', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 355, 6)))

CTD_ANON_14._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'SampleSetupId'), pyxb.binding.datatypes.string, scope=CTD_ANON_14, documentation='Optional pointer to a Sample Setup record in SMRT Link', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 360, 6)))

CTD_ANON_14._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(_Namespace_pbsample, 'BioSamples'), _ImportedBinding__pbsample.CTD_ANON_2, scope=CTD_ANON_14, documentation='List of biological samples.', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioSampleInfo.xsd', 126, 1)))
...
def _BuildAutomaton_13 ():
    ...
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 310, 24))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 320, 6))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 325, 24))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 330, 24))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 355, 6))
    counters.add(cc_5)
    cc_6 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 360, 6))
    counters.add(cc_6)
    cc_7 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 365, 6))
    counters.add(cc_7)
    states = []
    final_update = None
    ...
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_14._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'WellName')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 300, 6))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_14._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Concentration')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 305, 6))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_14._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'OnPlateLoadingConcentration')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 310, 24))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_14._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'InsertSize')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 315, 6))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_14._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'IsoSeq')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 320, 6))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_14._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'LoadingTarget')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 325, 24))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_14._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'MaxLoadingTime')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 330, 24))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_14._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'SampleReuseEnabled')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 335, 6))
    st_8 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_14._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'StageHotstartEnabled')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 340, 6))
    st_9 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_9)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_14._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'SizeSelectionEnabled')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 345, 6))
    st_10 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_10)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_14._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'UseCount')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 350, 6))
    st_11 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_11)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_5, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_14._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'DNAControlComplex')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 355, 6))
    st_12 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_12)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_6, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_14._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'SampleSetupId')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 360, 6))
    st_13 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_13)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_7, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_14._UseForTag(pyxb.namespace.ExpandedName(_Namespace_pbsample, 'BioSamples')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 365, 6))
...
CTD_ANON_15._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'MultiJobId'), pyxb.binding.datatypes.unsignedInt, scope=CTD_ANON_15, documentation='Id of the SMRT Link MultiJob that will create Jobs to process the Demuxed SubreadSets of this Collection, if it is Barcoded.', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 38, 24)))

CTD_ANON_15._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ConsensusReadSetRef'), pyxb.binding.datatypes.anyType, scope=CTD_ANON_15, documentation='Contains information on the CCS dataset of the Collection', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 43, 24)))

CTD_ANON_15._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'InstCtrlVer'), pyxb.binding.datatypes.string, scope=CTD_ANON_15, documentation='Instrument control software version. ', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 48, 6)))

CTD_ANON_15._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'SigProcVer'), pyxb.binding.datatypes.string, scope=CTD_ANON_15, documentation='Signal processing software version. ', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 53, 6)))

CTD_ANON_15._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Automation'), _ImportedBinding__pbbase.AutomationType, scope=CTD_ANON_15, documentation='Defines the collection workflow (e.g., robotic movement, movie acquisition) for a particular cell. ', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 75, 6)))

CTD_ANON_15._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'CollectionNumber'), pyxb.binding.datatypes.int, scope=CTD_ANON_15, documentation='Collection number for this plate well. Sample from one plate well or tube can be distributed to more than one cell. ', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 80, 6)))

CTD_ANON_15._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'CellIndex'), pyxb.binding.datatypes.int, scope=CTD_ANON_15, documentation='The zero-based index of this particular cell within the cell tray.  Likely to be in the range of [0-3]', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 85, 6)))

CTD_ANON_15._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'SetNumber'), pyxb.binding.datatypes.unsignedShort, scope=CTD_ANON_15, documentation='Formerly known as the look number.  1 - N.  Defaults to 1. 0 if the look is unknown. ', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 90, 6)))

CTD_ANON_15._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'CellPac'), _ImportedBinding__pbbase.SupplyKitCellPack, scope=CTD_ANON_15, documentation='The SMRT cell packaging supply information. ', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 95, 6)))

CTD_ANON_15._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ControlKit'), _ImportedBinding__pbbase.SupplyKitControl, scope=CTD_ANON_15, documentation='Defines the DNA control used for this experiment. ', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 100, 6)))

CTD_ANON_15._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'TemplatePrepKit'), _ImportedBinding__pbbase.SupplyKitTemplate, scope=CTD_ANON_15, documentation='Defines the template (sample) prep kit used for this experiment. Can be used to get back to the primary and adapter used. ', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 105, 6)))

CTD_ANON_15._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'BindingKit'), _ImportedBinding__pbbase.SupplyKitBinding, scope=CTD_ANON_15, documentation='The binding kit supply information. ', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 110, 6)))

CTD_ANON_15._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'SequencingKitPlate'), _ImportedBinding__pbrk.SupplyKitSequencing, scope=CTD_ANON_15, documentation='The sequencing kit supply information. ', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 115, 6)))

CTD_ANON_15._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'WashKitPlate'), _ImportedBinding__pbrk.SupplyKitSequencing, scope=CTD_ANON_15, documentation='The wash kit supply information. ', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 120, 6)))

CTD_ANON_15._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ComponentVersions'), CTD_ANON_2, nillable=pyxb.binding.datatypes.boolean(1), scope=CTD_ANON_15, documentation='Subcomponents involved in the generation of the data', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 145, 6)))

CTD_ANON_15._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'RunDetails'), CTD_ANON_3, scope=CTD_ANON_15, documentation='Information related to an instrument run.  A run can contain multiple chips, wells, and movies. ', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 180, 1)))

CTD_ANON_15._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Movie'), CTD_ANON_4, scope=CTD_ANON_15, documentation='A movie corresponds to one acquisition for a chip, one set (look) and one strobe. ', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 224, 1)))

CTD_ANON_15._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ExpirationData'), CTD_ANON_5, scope=CTD_ANON_15, documentation='Container for the expired consumable data. ', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 248, 1)))

CTD_ANON_15._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'WellSample'), CTD_ANON_14, scope=CTD_ANON_15, documentation='Container for the sample related data. ', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 292, 1)))

CTD_ANON_15._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Primary'), CTD_ANON_6, scope=CTD_ANON_15, documentation='Container for the primary analysis related data. ', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 372, 1)))

CTD_ANON_15._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Secondary'), CTD_ANON_11, scope=CTD_ANON_15, documentation='Container for the primary analysis related data. ', location=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 518, 1)))
...
def _BuildAutomaton_14 ():
    ...
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioBaseDataModel.xsd', 98, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 38, 24))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 43, 24))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 48, 6))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 53, 6))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 58, 6))
    counters.add(cc_5)
    cc_6 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 63, 6))
    counters.add(cc_6)
    cc_7 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 80, 6))
    counters.add(cc_7)
    cc_8 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 85, 6))
    counters.add(cc_8)
    cc_9 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 90, 6))
    counters.add(cc_9)
    cc_10 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 95, 6))
    counters.add(cc_10)
    cc_11 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 100, 6))
    counters.add(cc_11)
    cc_12 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 105, 6))
    counters.add(cc_12)
    cc_13 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 110, 6))
    counters.add(cc_13)
    cc_14 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 115, 6))
    counters.add(cc_14)
    cc_15 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 120, 6))
    counters.add(cc_15)
    cc_16 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 125, 6))
    counters.add(cc_16)
    cc_17 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 130, 6))
    counters.add(cc_17)
    cc_18 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 135, 6))
    counters.add(cc_18)
    cc_19 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 140, 6))
    counters.add(cc_19)
    cc_20 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 145, 6))
    counters.add(cc_20)
    states = []
    final_update = None
    ...
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_15._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'MultiJobId')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 38, 24))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_15._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'ConsensusReadSetRef')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 43, 24))
    st_2 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_15._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'InstCtrlVer')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 48, 6))
    st_3 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_15._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'SigProcVer')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 53, 6))
    st_4 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_15._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'RunDetails')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 58, 6))
    st_5 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_15._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Movie')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 63, 6))
    st_6 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_15._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'WellSample')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 68, 6))
    st_7 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_15._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Automation')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 75, 6))
    st_8 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_7, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_15._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'CollectionNumber')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 80, 6))
    st_9 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_9)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_8, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_15._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'CellIndex')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 85, 6))
    st_10 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_10)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_9, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_15._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'SetNumber')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 90, 6))
    st_11 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_11)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_10, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_15._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'CellPac')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 95, 6))
    st_12 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_12)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_11, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_15._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'ControlKit')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 100, 6))
    st_13 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_13)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_12, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_15._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'TemplatePrepKit')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 105, 6))
    st_14 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_14)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_13, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_15._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'BindingKit')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 110, 6))
    st_15 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_15)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_14, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_15._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'SequencingKitPlate')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 115, 6))
    st_16 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_16)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_15, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_15._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'WashKitPlate')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 120, 6))
    st_17 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_17)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_16, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_15._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Primary')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 125, 6))
    st_18 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_18)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_17, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_15._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Secondary')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 130, 6))
    st_19 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_19)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_18, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_15._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'UserDefinedFields')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 135, 6))
    st_20 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_20)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_19, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_15._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'ExpirationData')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 140, 6))
    st_21 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_21)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_20, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_15._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'ComponentVersions')), pyxb.utils.utility.Location('/tmp/tmpw82OIyxsds/PacBioCollectionMetadata.xsd', 145, 6))
