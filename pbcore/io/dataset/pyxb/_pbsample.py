...
# Generated 2019-01-03 10:12:27.643767 by PyXB version 1.2.4 using Python 2.7.9.final.0
...
class CTD_ANON (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmpaPDKwpxsds/PacBioSampleInfo.xsd', 96, 2)
    _ElementMap = {}
    _AttributeMap = {}
...
class CTD_ANON_ (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmpaPDKwpxsds/PacBioSampleInfo.xsd', 116, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
...
class BioSampleType (_ImportedBinding__pbbase.BaseEntityType):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmpaPDKwpxsds/PacBioSampleInfo.xsd', 8, 1)
    ...
    __DateReceived._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpaPDKwpxsds/PacBioSampleInfo.xsd', 34, 4)
    __DateReceived._UseLocation = pyxb.utils.utility.Location('/tmp/tmpaPDKwpxsds/PacBioSampleInfo.xsd', 34, 4)
    ...
    __Organism._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpaPDKwpxsds/PacBioSampleInfo.xsd', 39, 4)
    __Organism._UseLocation = pyxb.utils.utility.Location('/tmp/tmpaPDKwpxsds/PacBioSampleInfo.xsd', 39, 4)
    ...
    __Reference._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpaPDKwpxsds/PacBioSampleInfo.xsd', 44, 4)
    __Reference._UseLocation = pyxb.utils.utility.Location('/tmp/tmpaPDKwpxsds/PacBioSampleInfo.xsd', 44, 4)
    ...
    __DNAType._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpaPDKwpxsds/PacBioSampleInfo.xsd', 49, 4)
    __DNAType._UseLocation = pyxb.utils.utility.Location('/tmp/tmpaPDKwpxsds/PacBioSampleInfo.xsd', 49, 4)
    ...
    __Concentration._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpaPDKwpxsds/PacBioSampleInfo.xsd', 54, 4)
    __Concentration._UseLocation = pyxb.utils.utility.Location('/tmp/tmpaPDKwpxsds/PacBioSampleInfo.xsd', 54, 4)
    ...
    __QuantificationMethod._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpaPDKwpxsds/PacBioSampleInfo.xsd', 59, 4)
    __QuantificationMethod._UseLocation = pyxb.utils.utility.Location('/tmp/tmpaPDKwpxsds/PacBioSampleInfo.xsd', 59, 4)
    ...
    __SMRTBellConcentration._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpaPDKwpxsds/PacBioSampleInfo.xsd', 64, 4)
    __SMRTBellConcentration._UseLocation = pyxb.utils.utility.Location('/tmp/tmpaPDKwpxsds/PacBioSampleInfo.xsd', 64, 4)
    ...
    __SMRTBellQuantificationMethod._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpaPDKwpxsds/PacBioSampleInfo.xsd', 69, 4)
    __SMRTBellQuantificationMethod._UseLocation = pyxb.utils.utility.Location('/tmp/tmpaPDKwpxsds/PacBioSampleInfo.xsd', 69, 4)
    ...
    __BufferName._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpaPDKwpxsds/PacBioSampleInfo.xsd', 74, 4)
    __BufferName._UseLocation = pyxb.utils.utility.Location('/tmp/tmpaPDKwpxsds/PacBioSampleInfo.xsd', 74, 4)
    ...
    __SamplePrepKit._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpaPDKwpxsds/PacBioSampleInfo.xsd', 79, 4)
    __SamplePrepKit._UseLocation = pyxb.utils.utility.Location('/tmp/tmpaPDKwpxsds/PacBioSampleInfo.xsd', 79, 4)
    ...
    __TargetLibrarySize._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmpaPDKwpxsds/PacBioSampleInfo.xsd', 84, 4)
    __TargetLibrarySize._UseLocation = pyxb.utils.utility.Location('/tmp/tmpaPDKwpxsds/PacBioSampleInfo.xsd', 84, 4)
...
class CTD_ANON_3 (_ImportedBinding__pbbase.BaseEntityType):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmpaPDKwpxsds/PacBioSampleInfo.xsd', 19, 6)
    _ElementMap = _ImportedBinding__pbbase.BaseEntityType._ElementMap.copy()
    _AttributeMap = _ImportedBinding__pbbase.BaseEntityType._AttributeMap.copy()
    # Base type is _ImportedBinding__pbbase.BaseEntityType
...
BioSamplePointers = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'BioSamplePointers'), CTD_ANON, documentation='Back references to other BarcodedSampleType object UniqueIds which utilize this sample', location=pyxb.utils.utility.Location('/tmp/tmpaPDKwpxsds/PacBioSampleInfo.xsd', 92, 1))
Namespace.addCategoryObject('elementBinding', BioSamplePointers.name().localName(), BioSamplePointers)

BarcodedSamplePointers = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'BarcodedSamplePointers'), CTD_ANON_, documentation='Back references to other BarcodedSampleType object UniqueIds which utilize this sample', location=pyxb.utils.utility.Location('/tmp/tmpaPDKwpxsds/PacBioSampleInfo.xsd', 112, 1))
Namespace.addCategoryObject('elementBinding', BarcodedSamplePointers.name().localName(), BarcodedSamplePointers)

BioSamples = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'BioSamples'), CTD_ANON_2, documentation='List of biological samples.', location=pyxb.utils.utility.Location('/tmp/tmpaPDKwpxsds/PacBioSampleInfo.xsd', 126, 1))
Namespace.addCategoryObject('elementBinding', BioSamples.name().localName(), BioSamples)

BioSample = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'BioSample'), BioSampleType, documentation='An individual biological sample.', location=pyxb.utils.utility.Location('/tmp/tmpaPDKwpxsds/PacBioSampleInfo.xsd', 142, 1))
Namespace.addCategoryObject('elementBinding', BioSample.name().localName(), BioSample)

BioSamplesCsv = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'BioSamplesCsv'), _ImportedBinding__pbbase.InputOutputDataType, documentation='The name of the biosamples CSV.', location=pyxb.utils.utility.Location('/tmp/tmpaPDKwpxsds/PacBioSampleInfo.xsd', 137, 4))
Namespace.addCategoryObject('elementBinding', BioSamplesCsv.name().localName(), BioSamplesCsv)



CTD_ANON._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'BioSamplePointer'), pyxb.binding.datatypes.IDREF, scope=CTD_ANON, documentation='Pointer to a single biological sample', location=pyxb.utils.utility.Location('/tmp/tmpaPDKwpxsds/PacBioSampleInfo.xsd', 103, 5)))

CTD_ANON._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'BarcodedSamplePointers'), CTD_ANON_, scope=CTD_ANON, documentation='Back references to other BarcodedSampleType object UniqueIds which utilize this sample', location=pyxb.utils.utility.Location('/tmp/tmpaPDKwpxsds/PacBioSampleInfo.xsd', 112, 1)))
...
def _BuildAutomaton ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'BarcodedSamplePointers')), pyxb.utils.utility.Location('/tmp/tmpaPDKwpxsds/PacBioSampleInfo.xsd', 102, 5))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'BioSamplePointer')), pyxb.utils.utility.Location('/tmp/tmpaPDKwpxsds/PacBioSampleInfo.xsd', 103, 5))
...
CTD_ANON_._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'BarcodedSamplePointer'), pyxb.binding.datatypes.IDREF, scope=CTD_ANON_, documentation='Pointer to a group of barcoded samples', location=pyxb.utils.utility.Location('/tmp/tmpaPDKwpxsds/PacBioSampleInfo.xsd', 118, 4)))
...
def _BuildAutomaton_ ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'BarcodedSamplePointer')), pyxb.utils.utility.Location('/tmp/tmpaPDKwpxsds/PacBioSampleInfo.xsd', 118, 4))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
...
CTD_ANON_2._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'BioSamplesCsv'), _ImportedBinding__pbbase.InputOutputDataType, scope=CTD_ANON_2, documentation='The name of the biosamples CSV.', location=pyxb.utils.utility.Location('/tmp/tmpaPDKwpxsds/PacBioSampleInfo.xsd', 137, 4)))

CTD_ANON_2._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'BioSample'), BioSampleType, scope=CTD_ANON_2, documentation='An individual biological sample.', location=pyxb.utils.utility.Location('/tmp/tmpaPDKwpxsds/PacBioSampleInfo.xsd', 142, 1)))
...
def _BuildAutomaton_2 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpaPDKwpxsds/PacBioSampleInfo.xsd', 132, 16))
    counters.add(cc_0)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_2._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'BioSamplesCsv')), pyxb.utils.utility.Location('/tmp/tmpaPDKwpxsds/PacBioSampleInfo.xsd', 132, 16))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_2._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'BioSample')), pyxb.utils.utility.Location('/tmp/tmpaPDKwpxsds/PacBioSampleInfo.xsd', 133, 4))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
BioSampleType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'DNABarcodes'), CTD_ANON_3, scope=BioSampleType, documentation='A list of barcodes associated with the biological sample', location=pyxb.utils.utility.Location('/tmp/tmpaPDKwpxsds/PacBioSampleInfo.xsd', 15, 5)))
...
def _BuildAutomaton_3 ():
    ...
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpaPDKwpxsds/PacBioSampleInfo.xsd', 15, 5))
    counters.add(cc_1)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(BioSampleType._UseForTag(pyxb.namespace.ExpandedName(_Namespace_pbbase, 'Extensions')), pyxb.utils.utility.Location('/tmp/tmpaPDKwpxsds/PacBioBaseDataModel.xsd', 98, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(BioSampleType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'DNABarcodes')), pyxb.utils.utility.Location('/tmp/tmpaPDKwpxsds/PacBioSampleInfo.xsd', 15, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
CTD_ANON_3._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'DNABarcode'), _ImportedBinding__pbbase.DNABarcode, scope=CTD_ANON_3, documentation='A sequence of barcodes associated with the biological sample', location=pyxb.utils.utility.Location('/tmp/tmpaPDKwpxsds/PacBioSampleInfo.xsd', 23, 10)))
...
def _BuildAutomaton_4 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpaPDKwpxsds/PacBioSampleInfo.xsd', 19, 6))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmpaPDKwpxsds/PacBioBaseDataModel.xsd', 98, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('/tmp/tmpaPDKwpxsds/PacBioSampleInfo.xsd', 23, 10))
    counters.add(cc_2)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_3._UseForTag(pyxb.namespace.ExpandedName(_Namespace_pbbase, 'Extensions')), pyxb.utils.utility.Location('/tmp/tmpaPDKwpxsds/PacBioBaseDataModel.xsd', 98, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_3._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'DNABarcode')), pyxb.utils.utility.Location('/tmp/tmpaPDKwpxsds/PacBioSampleInfo.xsd', 23, 10))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    transitions = []
    transitions.append(fac.Transition(st_0, [
