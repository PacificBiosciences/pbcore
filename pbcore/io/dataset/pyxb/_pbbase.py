...
# Generated 2018-02-26 18:52:05.210992 by PyXB version 1.2.4 using Python 2.7.9.final.0
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:3144c9d4-1b69-11e8-a30f-0026b9fe0a90')
...
class STD_ANON (pyxb.binding.datatypes.dateTime):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 130, 3)
    _Documentation = None
...
class STD_ANON_ (pyxb.binding.datatypes.dateTime):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 138, 3)
    _Documentation = None
...
class STD_ANON_2 (pyxb.binding.datatypes.string):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 153, 5)
    _Documentation = None
...
class SupportedAcquisitionStates (pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 750, 1)
    _Documentation = None
...
class SupportedDataTypes (pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 780, 1)
    _Documentation = None
...
class SupportedNucleotides (pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 822, 1)
    _Documentation = None
...
class SupportedRunStates (pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 830, 1)
    _Documentation = None
...
class SupportedChipTypes (pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 846, 1)
    _Documentation = None
...
class SupportedFilterOperators (pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 864, 2)
    _Documentation = None
...
class SupportedFilterNames (pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 885, 2)
    _Documentation = None
...
class CTD_ANON (pyxb.binding.basis.complexTypeDefinition):
    ...
    __NumberFilterBins._DeclarationLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 29, 7)
    __NumberFilterBins._UseLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 29, 7)
...
class CTD_ANON_6 (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 299, 6)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
...
class CTD_ANON_7 (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 367, 6)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://pacificbiosciences.com/PacBioBaseDataModel.xsd}Automation uses Python identifier Automation
    __Automation = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'Automation'), 'Automation', '__httppacificbiosciences_comPacBioBaseDataModel_xsd_CTD_ANON_7_httppacificbiosciences_comPacBioBaseDataModel_xsdAutomation', True, pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 369, 8), )
...
class CTD_ANON_11 (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 525, 6)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __SNR_A._DeclarationLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 526, 7)
    __SNR_A._UseLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 526, 7)
    ...
    __SNR_C._DeclarationLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 527, 7)
    __SNR_C._UseLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 527, 7)
    ...
    __SNR_G._DeclarationLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 528, 7)
    __SNR_G._UseLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 528, 7)
    ...
    __SNR_T._DeclarationLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 529, 7)
    __SNR_T._UseLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 529, 7)
...
class CTD_ANON_12 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __NumberFilterBins._DeclarationLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 558, 16)
    __NumberFilterBins._UseLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 558, 16)
...
class CTD_ANON_13 (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 544, 24)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://pacificbiosciences.com/PacBioBaseDataModel.xsd}Value uses Python identifier Value
    __Value = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'Value'), 'Value', '__httppacificbiosciences_comPacBioBaseDataModel_xsd_CTD_ANON_13_httppacificbiosciences_comPacBioBaseDataModel_xsdValue', True, pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 546, 32), )
...
class CTD_ANON_17 (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 639, 6)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://pacificbiosciences.com/PacBioBaseDataModel.xsd}Val uses Python identifier Val
    __Val = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'Val'), 'Val', '__httppacificbiosciences_comPacBioBaseDataModel_xsd_CTD_ANON_17_httppacificbiosciences_comPacBioBaseDataModel_xsdVal', True, pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 641, 8), )
...
class CTD_ANON_19 (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 947, 4)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://pacificbiosciences.com/PacBioBaseDataModel.xsd}Item uses Python identifier Item
    __Item = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'Item'), 'Item', '__httppacificbiosciences_comPacBioBaseDataModel_xsd_CTD_ANON_19_httppacificbiosciences_comPacBioBaseDataModel_xsdItem', True, pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 949, 6), )
...
class DefaultsType (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 977, 4)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
...
class CTD_ANON_20 (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 983, 16)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
...
class BaseEntityType (pyxb.binding.basis.complexTypeDefinition):
    ...
    __Name._DeclarationLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 96, 2)
    __Name._UseLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 96, 2)
    ...
    __Description._DeclarationLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 101, 2)
    __Description._UseLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 101, 2)
    ...
    __Tags._DeclarationLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 106, 2)
    __Tags._UseLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 106, 2)
    ...
    __Format._DeclarationLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 111, 2)
    __Format._UseLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 111, 2)
    ...
    __ResourceId._DeclarationLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 116, 2)
    __ResourceId._UseLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 116, 2)
    ...
    __Version._DeclarationLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 121, 2)
    __Version._UseLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 121, 2)
    ...
    __CreatedAt._DeclarationLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 126, 2)
    __CreatedAt._UseLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 126, 2)
    ...
    __ModifiedAt._DeclarationLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 134, 2)
    __ModifiedAt._UseLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 134, 2)
...
class CTD_ANON_22 (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 918, 7)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __Name._DeclarationLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 919, 8)
    __Name._UseLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 919, 8)
    ...
    __Value._DeclarationLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 920, 8)
    __Value._UseLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 920, 8)
    ...
    __Operator._DeclarationLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 921, 8)
    __Operator._UseLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 921, 8)
    ...
    __Feature._DeclarationLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 922, 8)
    __Feature._UseLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 922, 8)
    ...
    __Assignment._DeclarationLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 923, 8)
    __Assignment._UseLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 923, 8)
...
class AnalogType (BaseEntityType):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 6, 1)
    ...
    __Base._DeclarationLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 55, 4)
    __Base._UseLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 55, 4)
    ...
    __Nucleotide._DeclarationLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 60, 4)
    __Nucleotide._UseLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 60, 4)
    ...
    __Wavelength._DeclarationLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 65, 4)
    __Wavelength._UseLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 65, 4)
    ...
    __CompoundID._DeclarationLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 70, 4)
    __CompoundID._UseLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 70, 4)
    ...
    __LotID._DeclarationLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 75, 4)
    __LotID._UseLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 75, 4)
...
class StrictEntityType (BaseEntityType):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 143, 1)
    _ElementMap = BaseEntityType._ElementMap.copy()
    _AttributeMap = BaseEntityType._AttributeMap.copy()
    # Base type is BaseEntityType
    ...
    __UniqueId._DeclarationLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 149, 4)
    __UniqueId._UseLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 149, 4)
    ...
    __MetaType._DeclarationLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 160, 4)
    __MetaType._UseLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 160, 4)
    ...
    __TimeStampedName._DeclarationLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 165, 4)
    __TimeStampedName._UseLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 165, 4)
...
class DataEntityType (BaseEntityType):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 184, 1)
    _ElementMap = BaseEntityType._ElementMap.copy()
    _AttributeMap = BaseEntityType._AttributeMap.copy()
    # Base type is BaseEntityType
    ...
    __ValueDataType._DeclarationLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 202, 4)
    __ValueDataType._UseLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 202, 4)
    ...
    __SimpleValue._DeclarationLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 207, 4)
    __SimpleValue._UseLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 207, 4)
    ...
    __MetaType._DeclarationLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 212, 4)
    __MetaType._UseLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 212, 4)
    ...
    __TimeStampedName._DeclarationLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 217, 4)
    __TimeStampedName._UseLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 217, 4)
...
class DNABarcode (BaseEntityType):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 235, 1)
    _ElementMap = BaseEntityType._ElementMap.copy()
    _AttributeMap = BaseEntityType._AttributeMap.copy()
    # Base type is BaseEntityType
    ...
    __DNASequence._DeclarationLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 241, 4)
    __DNASequence._UseLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 241, 4)
...
class AutomationType (BaseEntityType):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 294, 1)
    _ElementMap = BaseEntityType._ElementMap.copy()
    _AttributeMap = BaseEntityType._AttributeMap.copy()
    # Base type is BaseEntityType
    ...
    __PartNumber._DeclarationLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 307, 4)
    __PartNumber._UseLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 307, 4)
    ...
    __IsRestricted._DeclarationLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 312, 4)
    __IsRestricted._UseLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 312, 4)
    ...
    __IsObsolete._DeclarationLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 317, 4)
    __IsObsolete._UseLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 317, 4)
    ...
    __IsDefault._DeclarationLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 322, 4)
    __IsDefault._UseLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 322, 4)
...
By default, any PN is compatible for use with other PNs in the system.  In order to exclude the usage of one or more PNs with this one, the pairwise incompatible PNs are listed here."""
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 335, 1)
    _ElementMap = BaseEntityType._ElementMap.copy()
    _AttributeMap = BaseEntityType._AttributeMap.copy()
    # Base type is BaseEntityType
    ...
    __PartA._DeclarationLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 343, 4)
    __PartA._UseLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 343, 4)
    ...
    __PartB._DeclarationLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 348, 4)
    __PartB._UseLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 348, 4)
...
class AutomationConstraintType (BaseEntityType):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 356, 1)
    _ElementMap = BaseEntityType._ElementMap.copy()
    _AttributeMap = BaseEntityType._AttributeMap.copy()
    # Base type is BaseEntityType
    ...
    __SupportsCellReuse._DeclarationLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 374, 4)
    __SupportsCellReuse._UseLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 374, 4)
    ...
    __SupportsStageStart._DeclarationLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 379, 4)
    __SupportsStageStart._UseLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 379, 4)
    ...
    __MaxCollectionsPerCell._DeclarationLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 384, 4)
    __MaxCollectionsPerCell._UseLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 384, 4)
    ...
    __MinMovieLength._DeclarationLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 389, 4)
    __MinMovieLength._UseLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 389, 4)
    ...
    __MaxMovieLength._DeclarationLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 394, 4)
    __MaxMovieLength._UseLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 394, 4)
    ...
    __MinInsertSize._DeclarationLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 399, 4)
    __MinInsertSize._UseLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 399, 4)
    ...
    __MaxInsertSize._DeclarationLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 404, 4)
    __MaxInsertSize._UseLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 404, 4)
...
class CTD_ANON_23 (BaseEntityType):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 470, 6)
    _ElementMap = BaseEntityType._ElementMap.copy()
    _AttributeMap = BaseEntityType._AttributeMap.copy()
    # Base type is BaseEntityType
...
class StatsContinuousDistType (BaseEntityType):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 569, 1)
    _ElementMap = BaseEntityType._ElementMap.copy()
    _AttributeMap = BaseEntityType._AttributeMap.copy()
    # Base type is BaseEntityType
    ...
    __Channel._DeclarationLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 596, 4)
    __Channel._UseLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 596, 4)
...
class StatsDiscreteDistType (BaseEntityType):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 600, 1)
    _ElementMap = BaseEntityType._ElementMap.copy()
    _AttributeMap = BaseEntityType._AttributeMap.copy()
    # Base type is BaseEntityType
...
class StatsTimeSeriesType (BaseEntityType):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 627, 1)
    _ElementMap = BaseEntityType._ElementMap.copy()
    _AttributeMap = BaseEntityType._AttributeMap.copy()
    # Base type is BaseEntityType
...
class CTD_ANON_24 (AnalogType):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 177, 2)
...
class CTD_ANON_25 (AnalogType):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 253, 2)
    _ElementMap = AnalogType._ElementMap.copy()
    _AttributeMap = AnalogType._AttributeMap.copy()
    # Base type is AnalogType
...
class InputOutputDataType (StrictEntityType):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 269, 1)
...
If the part number has an NFC associated with it, the contents of the NFC may be encoded here."""
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 412, 1)
    ...
    __PartNumber._DeclarationLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 423, 4)
    __PartNumber._UseLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 423, 4)
    ...
    __LotNumber._DeclarationLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 428, 4)
    __LotNumber._UseLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 428, 4)
    ...
    __Barcode._DeclarationLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 433, 4)
    __Barcode._UseLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 433, 4)
    ...
    __ExpirationDate._DeclarationLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 438, 4)
    __ExpirationDate._UseLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 438, 4)
    ...
    __IsObsolete._DeclarationLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 443, 4)
    __IsObsolete._UseLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 443, 4)
    ...
    __IsRestricted._DeclarationLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 444, 4)
    __IsRestricted._UseLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 444, 4)
...
class RecordedEventType (DataEntityType):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 448, 1)
    _ElementMap = DataEntityType._ElementMap.copy()
    _AttributeMap = DataEntityType._AttributeMap.copy()
    # Base type is DataEntityType
    ...
    __Context._DeclarationLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 454, 4)
    __Context._UseLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 454, 4)
...
class SequencingChemistry (DataEntityType):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 462, 1)
    _ElementMap = DataEntityType._ElementMap.copy()
    _AttributeMap = DataEntityType._AttributeMap.copy()
    # Base type is DataEntityType
...
class SequencingChemistryConfig (DataEntityType):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 500, 1)
    _ElementMap = DataEntityType._ElementMap.copy()
    _AttributeMap = DataEntityType._AttributeMap.copy()
    # Base type is DataEntityType
...
class IndexedDataType (InputOutputDataType):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 274, 1)
...
class SupplyKitBinding (PartNumberType):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 649, 1)
...
class SupplyKitCellPack (PartNumberType):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 670, 1)
    _ElementMap = PartNumberType._ElementMap.copy()
    _AttributeMap = PartNumberType._AttributeMap.copy()
    # Base type is PartNumberType
    ...
    __SupportsCellReuse._DeclarationLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 683, 4)
    __SupportsCellReuse._UseLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 683, 4)
    ...
    __MovieTimeGrade._DeclarationLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 688, 4)
    __MovieTimeGrade._UseLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 688, 4)
...
class SupplyKitControl (PartNumberType):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 696, 1)
    _ElementMap = PartNumberType._ElementMap.copy()
    _AttributeMap = PartNumberType._AttributeMap.copy()
    # Base type is PartNumberType
...
class SupplyKitTemplate (PartNumberType):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 713, 1)
    _ElementMap = PartNumberType._ElementMap.copy()
    _AttributeMap = PartNumberType._AttributeMap.copy()
    # Base type is PartNumberType
    ...
    __MinInsertSize._DeclarationLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 737, 4)
    __MinInsertSize._UseLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 737, 4)
    ...
    __MaxInsertSize._DeclarationLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 742, 4)
    __MaxInsertSize._UseLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 742, 4)
...
class CTD_ANON_26 (IndexedDataType):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 935, 2)
...
ExtensionElement = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ExtensionElement'), pyxb.binding.datatypes.anyType, documentation='A generic element whose contents are undefined at the schema level.  This is used to extend the data model.', location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 859, 1))
Namespace.addCategoryObject('elementBinding', ExtensionElement.name().localName(), ExtensionElement)

DataPointers = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'DataPointers'), CTD_ANON_3, documentation='Pointer list to UniqueIds in the system', location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 225, 1))
Namespace.addCategoryObject('elementBinding', DataPointers.name().localName(), DataPointers)

ExternalResources = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ExternalResources'), CTD_ANON_4, documentation='Pointers to data that do not reside inside the parent structure', location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 259, 1))
Namespace.addCategoryObject('elementBinding', ExternalResources.name().localName(), ExternalResources)

PacBioSequencingChemistry = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'PacBioSequencingChemistry'), CTD_ANON_9, documentation='Root element for document containing the container of analog set, SequencingChemistryConfig', location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 490, 1))
Namespace.addCategoryObject('elementBinding', PacBioSequencingChemistry.name().localName(), PacBioSequencingChemistry)

ValueDataType = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ValueDataType'), SupportedDataTypes, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 857, 1))
Namespace.addCategoryObject('elementBinding', ValueDataType.name().localName(), ValueDataType)

KeyValueMap = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'KeyValueMap'), KeyValueMap_, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 941, 1))
Namespace.addCategoryObject('elementBinding', KeyValueMap.name().localName(), KeyValueMap)

CellMaxMovieTimes = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'CellMaxMovieTimes'), KeyValueMap_, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 942, 1))
Namespace.addCategoryObject('elementBinding', CellMaxMovieTimes.name().localName(), CellMaxMovieTimes)

Defaults = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Defaults'), DefaultsType, nillable=pyxb.binding.datatypes.boolean(1), documentation='Default paramaters and filters which may be applied to PartNumber types in order to constrain them via parameterization', location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 972, 4))
Namespace.addCategoryObject('elementBinding', Defaults.name().localName(), Defaults)

DataEntity = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'DataEntity'), DataEntityType, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 183, 1))
Namespace.addCategoryObject('elementBinding', DataEntity.name().localName(), DataEntity)

AutomationParameter = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'AutomationParameter'), DataEntityType, documentation='One or more collection parameters, such as MovieLength, InsertSize, UseStageStart, IsControl, etc..', location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 330, 1))
Namespace.addCategoryObject('elementBinding', AutomationParameter.name().localName(), AutomationParameter)

ConfigSetAnalog = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ConfigSetAnalog'), CTD_ANON_24, documentation='An unlimited number of analogs listed for the purposes of hosting in a configuration file. e.g. a list of all possible analogs on the system', location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 173, 1))
Namespace.addCategoryObject('elementBinding', ConfigSetAnalog.name().localName(), ConfigSetAnalog)

DyeSetAnalog = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'DyeSetAnalog'), CTD_ANON_25, documentation='A set of four analogs, one for each of the nucleotides, grouped together for the purposes of a single experiment.', location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 249, 1))
Namespace.addCategoryObject('elementBinding', DyeSetAnalog.name().localName(), DyeSetAnalog)

ChemistryConfig = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ChemistryConfig'), SequencingChemistryConfig, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 971, 1))
Namespace.addCategoryObject('elementBinding', ChemistryConfig.name().localName(), ChemistryConfig)

ExternalResource = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ExternalResource'), CTD_ANON_26, documentation='for example, an output file could be the BAM file, which could be associated with multiple indices into it.', location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 931, 1))
Namespace.addCategoryObject('elementBinding', ExternalResource.name().localName(), ExternalResource)



CTD_ANON._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Values'), CTD_ANON_, scope=CTD_ANON, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 16, 8)))
...
def _BuildAutomaton ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Values')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 16, 8))
...
def _BuildAutomaton_ ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Value')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 19, 11))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
...
def _BuildAutomaton_2 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 91, 6))
    counters.add(cc_0)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_2._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'ExtensionElement')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 91, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
CTD_ANON_3._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'DataPointer'), pyxb.binding.datatypes.IDREF, scope=CTD_ANON_3, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 231, 4)))
...
def _BuildAutomaton_3 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 231, 4))
    counters.add(cc_0)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_3._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'DataPointer')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 231, 4))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
CTD_ANON_4._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ExternalResource'), CTD_ANON_26, scope=CTD_ANON_4, documentation='for example, an output file could be the BAM file, which could be associated with multiple indices into it.', location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 931, 1)))
...
def _BuildAutomaton_4 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_4._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'ExternalResource')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 265, 4))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
CTD_ANON_5._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'FileIndex'), InputOutputDataType, scope=CTD_ANON_5, documentation='e.g. index for output files, allowing one to find information in the output file', location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 281, 8)))
...
def _BuildAutomaton_5 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_5._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'FileIndex')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 281, 8))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
def _BuildAutomaton_6 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_6._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'AutomationParameter')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 301, 8))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
CTD_ANON_7._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Automation'), AutomationType, scope=CTD_ANON_7, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 369, 8)))
...
def _BuildAutomaton_7 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_7._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Automation')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 369, 8))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
CTD_ANON_8._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Analog'), AnalogType, scope=CTD_ANON_8, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 477, 13)))
...
def _BuildAutomaton_8 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=1, max=4, metadata=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 477, 13))
    counters.add(cc_0)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_8._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Analog')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 477, 13))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
CTD_ANON_9._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ChemistryConfig'), SequencingChemistryConfig, scope=CTD_ANON_9, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 971, 1)))
...
def _BuildAutomaton_9 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_9._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'ChemistryConfig')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 496, 4))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    st_0._set_transitionSet(transitions)
...
CTD_ANON_10._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Analog'), AnalogType, scope=CTD_ANON_10, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 510, 8)))
...
def _BuildAutomaton_10 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=1, max=4, metadata=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 510, 8))
    counters.add(cc_0)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_10._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Analog')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 510, 8))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
CTD_ANON_12._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Values'), CTD_ANON_13, scope=CTD_ANON_12, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 543, 20)))
...
def _BuildAutomaton_11 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_12._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Values')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 543, 20))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    st_0._set_transitionSet(transitions)
...
def _BuildAutomaton_12 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_13._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Value')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 546, 32))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
CTD_ANON_14._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'BinCount'), pyxb.binding.datatypes.int, scope=CTD_ANON_14, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 585, 8)))
...
def _BuildAutomaton_13 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_14._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'BinCount')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 585, 8))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
CTD_ANON_15._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'BinCount'), pyxb.binding.datatypes.int, scope=CTD_ANON_15, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 611, 8)))
...
def _BuildAutomaton_14 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_15._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'BinCount')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 611, 8))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
CTD_ANON_16._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'BinLabel'), pyxb.binding.datatypes.string, scope=CTD_ANON_16, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 619, 8)))
...
def _BuildAutomaton_15 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_16._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'BinLabel')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 619, 8))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
CTD_ANON_17._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Val'), pyxb.binding.datatypes.float, scope=CTD_ANON_17, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 641, 8)))
...
def _BuildAutomaton_16 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 641, 8))
    counters.add(cc_0)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_17._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Val')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 641, 8))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
UserDefinedFieldsType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'DataEntities'), DataEntityType, scope=UserDefinedFieldsType, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 854, 3)))
...
def _BuildAutomaton_17 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(UserDefinedFieldsType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'DataEntities')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 854, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
FilterType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Properties'), CTD_ANON_18, scope=FilterType, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 914, 3)))
...
def _BuildAutomaton_18 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(FilterType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Properties')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 914, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    st_0._set_transitionSet(transitions)
...
CTD_ANON_18._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Property'), CTD_ANON_22, scope=CTD_ANON_18, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 917, 6)))
...
def _BuildAutomaton_19 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_18._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Property')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 917, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
KeyValueMap_._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Items'), CTD_ANON_19, scope=KeyValueMap_, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 946, 3)))
...
def _BuildAutomaton_20 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(KeyValueMap_._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Items')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 946, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    st_0._set_transitionSet(transitions)
...
CTD_ANON_19._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Item'), MapItemType, scope=CTD_ANON_19, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 949, 6)))
...
def _BuildAutomaton_21 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 949, 6))
    counters.add(cc_0)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_19._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Item')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 949, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
MapType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'KeyValueMap'), KeyValueMap_, scope=MapType, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 961, 3)))
...
def _BuildAutomaton_22 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(MapType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'KeyValueMap')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 961, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    st_0._set_transitionSet(transitions)
...
MapItemType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Key'), pyxb.binding.datatypes.string, scope=MapItemType, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 966, 3)))

MapItemType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Value'), pyxb.binding.datatypes.anyType, scope=MapItemType, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 967, 3)))

MapItemType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Description'), pyxb.binding.datatypes.string, scope=MapItemType, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 968, 3)))
...
def _BuildAutomaton_23 ():
    ...
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(MapItemType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Key')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 966, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(MapItemType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Value')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 967, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(MapItemType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Description')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 968, 3))
...
DefaultsType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'AutomationParameters'), CTD_ANON_20, nillable=pyxb.binding.datatypes.boolean(1), scope=DefaultsType, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 982, 12)))

DefaultsType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Filters'), CTD_ANON_21, nillable=pyxb.binding.datatypes.boolean(1), scope=DefaultsType, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 989, 12)))
...
def _BuildAutomaton_24 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 982, 12))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 989, 12))
    counters.add(cc_1)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(DefaultsType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'AutomationParameters')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 982, 12))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(DefaultsType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Filters')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 989, 12))
...
def _BuildAutomaton_25 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_20._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'AutomationParameter')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 985, 24))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
CTD_ANON_21._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Filter'), FilterType, scope=CTD_ANON_21, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 992, 24)))
...
def _BuildAutomaton_26 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_21._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Filter')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 992, 24))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
BaseEntityType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Extensions'), CTD_ANON_2, scope=BaseEntityType, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 88, 3)))
...
def _BuildAutomaton_27 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 88, 3))
    counters.add(cc_0)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(BaseEntityType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Extensions')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 88, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
AnalogType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Spectrum'), CTD_ANON, scope=AnalogType, documentation='A vector of probabilities, given in the order of increasing filter-bin wavelength, that light emitted by the analog will fall in the corresponding filter bin of the instrument detection system. By convention, the values are normalized to sum to 1.', location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 10, 5)))

AnalogType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'RelativeAmplitude'), pyxb.binding.datatypes.float, scope=AnalogType, documentation='Relative intensity of emission vs. a reference analog using standardized metrology \u2013 e.g., relative to the amplitude of the \u201c542\u201d analog as measured by the mean DWS pkMid on the Astro instrument.', location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 36, 5)))

AnalogType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'IntraPulseXsnCV'), pyxb.binding.datatypes.float, scope=AnalogType, documentation='The 1-sigma fractional variation of the intra-pulse signal, independent of any Shot noise associated with that signal', location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 41, 5)))

AnalogType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'InterPulseXsnCV'), pyxb.binding.datatypes.float, scope=AnalogType, documentation='The 1-sigma fractional variation, pulse-to-pulse, of the mean signal level (i.e., the pkMid).', location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 46, 5)))

AnalogType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'DiffusionXsnCV'), pyxb.binding.datatypes.float, scope=AnalogType, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 51, 5)))

AnalogType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'PulseWidthMeanSeconds'), pyxb.binding.datatypes.float, scope=AnalogType, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 52, 20)))

AnalogType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'IpdMeanSeconds'), pyxb.binding.datatypes.float, scope=AnalogType, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 53, 20)))
...
def _BuildAutomaton_28 ():
    ...
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 88, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 52, 20))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 53, 20))
    counters.add(cc_2)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(AnalogType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Extensions')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 88, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(AnalogType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Spectrum')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 10, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(AnalogType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'RelativeAmplitude')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 36, 5))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(AnalogType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'IntraPulseXsnCV')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 41, 5))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(AnalogType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'InterPulseXsnCV')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 46, 5))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(AnalogType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'DiffusionXsnCV')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 51, 5))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(AnalogType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'PulseWidthMeanSeconds')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 52, 20))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(AnalogType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'IpdMeanSeconds')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 53, 20))
...
def _BuildAutomaton_29 ():
    ...
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(StrictEntityType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Extensions')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 88, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
def _BuildAutomaton_30 ():
    ...
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 88, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 196, 5))
    counters.add(cc_1)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(DataEntityType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Extensions')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 88, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(DataEntityType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'CheckSum')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 196, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
def _BuildAutomaton_31 ():
    ...
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(DNABarcode._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Extensions')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 88, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
AutomationType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'AutomationParameters'), CTD_ANON_6, scope=AutomationType, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 298, 5)))
...
def _BuildAutomaton_32 ():
    ...
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 88, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 298, 5))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 305, 5))
    counters.add(cc_2)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(AutomationType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Extensions')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 88, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(AutomationType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'AutomationParameters')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 298, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(AutomationType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Defaults')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 305, 5))
...
def _BuildAutomaton_33 ():
    ...
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(IncompatiblePairType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Extensions')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 88, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
def _BuildAutomaton_34 ():
    ...
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 88, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 363, 5))
    counters.add(cc_1)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(AutomationConstraintType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Extensions')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 88, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(AutomationConstraintType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Automations')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 363, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
CTD_ANON_23._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Analogs'), CTD_ANON_8, scope=CTD_ANON_23, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 474, 10)))
...
def _BuildAutomaton_35 ():
    ...
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_23._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Extensions')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 88, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_23._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Analogs')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 474, 10))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
StatsContinuousDistType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'SampleSize'), pyxb.binding.datatypes.int, scope=StatsContinuousDistType, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 576, 5)))

StatsContinuousDistType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'SampleMean'), pyxb.binding.datatypes.float, scope=StatsContinuousDistType, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 577, 5)))

StatsContinuousDistType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'SampleMed'), pyxb.binding.datatypes.float, scope=StatsContinuousDistType, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 578, 5)))

StatsContinuousDistType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'SampleStd'), pyxb.binding.datatypes.float, scope=StatsContinuousDistType, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 579, 5)))

StatsContinuousDistType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Sample95thPct'), pyxb.binding.datatypes.float, scope=StatsContinuousDistType, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 580, 5)))

StatsContinuousDistType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'NumBins'), pyxb.binding.datatypes.int, scope=StatsContinuousDistType, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 581, 5)))

StatsContinuousDistType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'BinCounts'), CTD_ANON_14, scope=StatsContinuousDistType, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 582, 5)))

StatsContinuousDistType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'BinWidth'), pyxb.binding.datatypes.float, scope=StatsContinuousDistType, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 589, 5)))

StatsContinuousDistType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'MinOutlierValue'), pyxb.binding.datatypes.float, scope=StatsContinuousDistType, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 590, 5)))

StatsContinuousDistType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'MinBinValue'), pyxb.binding.datatypes.float, scope=StatsContinuousDistType, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 591, 5)))

StatsContinuousDistType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'MaxBinValue'), pyxb.binding.datatypes.float, scope=StatsContinuousDistType, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 592, 5)))

StatsContinuousDistType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'MaxOutlierValue'), pyxb.binding.datatypes.float, scope=StatsContinuousDistType, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 593, 5)))

StatsContinuousDistType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'MetricDescription'), pyxb.binding.datatypes.string, scope=StatsContinuousDistType, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 594, 5)))
...
def _BuildAutomaton_36 ():
    ...
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 88, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 590, 5))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 591, 5))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 592, 5))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 593, 5))
    counters.add(cc_4)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(StatsContinuousDistType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Extensions')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 88, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(StatsContinuousDistType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'SampleSize')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 576, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(StatsContinuousDistType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'SampleMean')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 577, 5))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(StatsContinuousDistType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'SampleMed')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 578, 5))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(StatsContinuousDistType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'SampleStd')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 579, 5))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(StatsContinuousDistType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Sample95thPct')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 580, 5))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(StatsContinuousDistType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'NumBins')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 581, 5))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(StatsContinuousDistType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'BinCounts')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 582, 5))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(StatsContinuousDistType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'BinWidth')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 589, 5))
    st_8 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(StatsContinuousDistType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'MinOutlierValue')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 590, 5))
    st_9 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_9)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(StatsContinuousDistType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'MinBinValue')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 591, 5))
    st_10 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_10)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(StatsContinuousDistType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'MaxBinValue')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 592, 5))
    st_11 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_11)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(StatsContinuousDistType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'MaxOutlierValue')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 593, 5))
    st_12 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_12)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(StatsContinuousDistType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'MetricDescription')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 594, 5))
...
StatsDiscreteDistType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'NumBins'), pyxb.binding.datatypes.int, scope=StatsDiscreteDistType, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 607, 5)))

StatsDiscreteDistType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'BinCounts'), CTD_ANON_15, scope=StatsDiscreteDistType, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 608, 5)))

StatsDiscreteDistType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'MetricDescription'), pyxb.binding.datatypes.string, scope=StatsDiscreteDistType, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 615, 5)))

StatsDiscreteDistType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'BinLabels'), CTD_ANON_16, scope=StatsDiscreteDistType, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 616, 5)))
...
def _BuildAutomaton_37 ():
    ...
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(StatsDiscreteDistType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Extensions')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 88, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(StatsDiscreteDistType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'NumBins')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 607, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(StatsDiscreteDistType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'BinCounts')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 608, 5))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(StatsDiscreteDistType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'MetricDescription')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 615, 5))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(StatsDiscreteDistType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'BinLabels')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 616, 5))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
StatsTimeSeriesType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'TimeUnits'), pyxb.binding.datatypes.string, scope=StatsTimeSeriesType, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 634, 5)))

StatsTimeSeriesType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ValueUnits'), pyxb.binding.datatypes.string, scope=StatsTimeSeriesType, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 635, 5)))

StatsTimeSeriesType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'StartTime'), pyxb.binding.datatypes.float, scope=StatsTimeSeriesType, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 636, 5)))

StatsTimeSeriesType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'MeasInterval'), pyxb.binding.datatypes.float, scope=StatsTimeSeriesType, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 637, 5)))

StatsTimeSeriesType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Values'), CTD_ANON_17, scope=StatsTimeSeriesType, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 638, 5)))
...
def _BuildAutomaton_38 ():
    ...
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 88, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 638, 5))
    counters.add(cc_1)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(StatsTimeSeriesType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Extensions')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 88, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(StatsTimeSeriesType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'TimeUnits')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 634, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(StatsTimeSeriesType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'ValueUnits')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 635, 5))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(StatsTimeSeriesType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'StartTime')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 636, 5))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(StatsTimeSeriesType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'MeasInterval')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 637, 5))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(StatsTimeSeriesType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Values')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 638, 5))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
def _BuildAutomaton_39 ():
    ...
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_24._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Extensions')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 88, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_24._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Spectrum')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 10, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_24._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'RelativeAmplitude')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 36, 5))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_24._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'IntraPulseXsnCV')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 41, 5))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_24._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'InterPulseXsnCV')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 46, 5))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_24._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'DiffusionXsnCV')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 51, 5))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_24._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'PulseWidthMeanSeconds')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 52, 20))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_24._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'IpdMeanSeconds')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 53, 20))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
def _BuildAutomaton_40 ():
    ...
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_25._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Extensions')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 88, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_25._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Spectrum')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 10, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_25._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'RelativeAmplitude')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 36, 5))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_25._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'IntraPulseXsnCV')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 41, 5))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_25._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'InterPulseXsnCV')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 46, 5))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_25._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'DiffusionXsnCV')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 51, 5))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_25._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'PulseWidthMeanSeconds')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 52, 20))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_25._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'IpdMeanSeconds')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 53, 20))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
def _BuildAutomaton_41 ():
    ...
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(InputOutputDataType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Extensions')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 88, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
def _BuildAutomaton_42 ():
    ...
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 196, 5))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 421, 5))
    counters.add(cc_2)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(PartNumberType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Extensions')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 88, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(PartNumberType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'CheckSum')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 196, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(PartNumberType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Defaults')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 421, 5))
    st_2 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
def _BuildAutomaton_43 ():
    ...
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(RecordedEventType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Extensions')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 88, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(RecordedEventType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'CheckSum')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 196, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
SequencingChemistry._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'DyeSet'), CTD_ANON_23, scope=SequencingChemistry, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 469, 5)))
...
def _BuildAutomaton_44 ():
    ...
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(SequencingChemistry._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Extensions')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 88, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(SequencingChemistry._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'CheckSum')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 196, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(SequencingChemistry._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'DyeSet')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 469, 5))
    st_2 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
SequencingChemistryConfig._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Analogs'), CTD_ANON_10, scope=SequencingChemistryConfig, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 507, 5)))

SequencingChemistryConfig._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'DefaultLaserSetPoint'), pyxb.binding.datatypes.float, scope=SequencingChemistryConfig, documentation="The laser power at the input couple, needed to achieve predefined performance requirements based on a median 'golden' SMRT Cell.", location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 514, 5)))

SequencingChemistryConfig._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'SNRCut'), pyxb.binding.datatypes.float, scope=SequencingChemistryConfig, documentation='The SNRCut is applied in PPA (baz2bam) as a read-quality filter.', location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 519, 5)))

SequencingChemistryConfig._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'TargetSNR'), CTD_ANON_11, scope=SequencingChemistryConfig, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 524, 5)))

SequencingChemistryConfig._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ReferenceSnr'), pyxb.binding.datatypes.float, scope=SequencingChemistryConfig, documentation='The nominal or default SNR of the reference analog under the chemistry and detection configuration.', location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 532, 20)))
...
def _BuildAutomaton_45 ():
    ...
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(SequencingChemistryConfig._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Extensions')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 88, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(SequencingChemistryConfig._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'CheckSum')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 196, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(SequencingChemistryConfig._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Analogs')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 507, 5))
    st_2 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(SequencingChemistryConfig._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'DefaultLaserSetPoint')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 514, 5))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(SequencingChemistryConfig._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'SNRCut')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 519, 5))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(SequencingChemistryConfig._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'TargetSNR')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 524, 5))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(SequencingChemistryConfig._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'ReferenceSnr')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 532, 20))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(SequencingChemistryConfig._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'ReferenceSpectrum')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 537, 8))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
IndexedDataType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ExternalResources'), CTD_ANON_4, scope=IndexedDataType, documentation='Pointers to data that do not reside inside the parent structure', location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 259, 1)))

IndexedDataType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'FileIndices'), CTD_ANON_5, scope=IndexedDataType, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 278, 5)))
...
def _BuildAutomaton_46 ():
    ...
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 88, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 278, 5))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 289, 5))
    counters.add(cc_2)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(IndexedDataType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Extensions')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 88, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(IndexedDataType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'FileIndices')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 278, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(IndexedDataType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'ExternalResources')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 289, 5))
    st_2 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
def _BuildAutomaton_47 ():
    ...
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 421, 5))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 656, 5))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 661, 5))
    counters.add(cc_4)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(SupplyKitBinding._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Extensions')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 88, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(SupplyKitBinding._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'CheckSum')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 196, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(SupplyKitBinding._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Defaults')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 421, 5))
    st_2 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(SupplyKitBinding._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Control')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 656, 5))
    st_3 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(SupplyKitBinding._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'IsControlUsed')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 661, 5))
...
def _BuildAutomaton_48 ():
    ...
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 421, 5))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 677, 5))
    counters.add(cc_3)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(SupplyKitCellPack._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Extensions')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 88, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(SupplyKitCellPack._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'CheckSum')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 196, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(SupplyKitCellPack._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Defaults')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 421, 5))
    st_2 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(SupplyKitCellPack._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'ChipLayout')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 677, 5))
    st_3 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
SupplyKitControl._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'InternalControlName'), pyxb.binding.datatypes.string, scope=SupplyKitControl, documentation='Defines the internal control name, if any. ', location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 703, 5)))

SupplyKitControl._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'CustomSequence'), pyxb.binding.datatypes.string, nillable=pyxb.binding.datatypes.boolean(1), scope=SupplyKitControl, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 708, 5)))
...
def _BuildAutomaton_49 ():
    ...
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 421, 5))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 703, 5))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 708, 5))
    counters.add(cc_4)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(SupplyKitControl._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Extensions')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 88, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(SupplyKitControl._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'CheckSum')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 196, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(SupplyKitControl._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Defaults')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 421, 5))
    st_2 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(SupplyKitControl._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'InternalControlName')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 703, 5))
    st_3 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(SupplyKitControl._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'CustomSequence')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 708, 5))
    st_4 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
SupplyKitTemplate._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'LeftAdaptorSequence'), pyxb.binding.datatypes.string, scope=SupplyKitTemplate, documentation='Left adapter DNA sequence.', location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 720, 5)))

SupplyKitTemplate._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'LeftPrimerSequence'), pyxb.binding.datatypes.string, scope=SupplyKitTemplate, location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 725, 5)))

SupplyKitTemplate._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'RightAdaptorSequence'), pyxb.binding.datatypes.string, scope=SupplyKitTemplate, documentation='Right adapter DNA sequence.  If not specified, a symmetric adapter model is inferred, where the left adapter sequence is used wherever needed.', location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 726, 5)))

SupplyKitTemplate._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'RightPrimerSequence'), pyxb.binding.datatypes.string, scope=SupplyKitTemplate, documentation='Right primaer sequence.  If not specified, a symmetric model is inferred, where the left primer sequence is used wherever needed.', location=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 731, 5)))
...
def _BuildAutomaton_50 ():
    ...
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 421, 5))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 720, 5))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 725, 5))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 726, 5))
    counters.add(cc_5)
    cc_6 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 731, 5))
    counters.add(cc_6)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(SupplyKitTemplate._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Extensions')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 88, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(SupplyKitTemplate._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'CheckSum')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 196, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(SupplyKitTemplate._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Defaults')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 421, 5))
    st_2 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(SupplyKitTemplate._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'LeftAdaptorSequence')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 720, 5))
    st_3 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(SupplyKitTemplate._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'LeftPrimerSequence')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 725, 5))
    st_4 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_5, False))
    symbol = pyxb.binding.content.ElementUse(SupplyKitTemplate._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'RightAdaptorSequence')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 726, 5))
    st_5 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_6, False))
    symbol = pyxb.binding.content.ElementUse(SupplyKitTemplate._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'RightPrimerSequence')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 731, 5))
...
def _BuildAutomaton_51 ():
    ...
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_26._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Extensions')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 88, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_26._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'FileIndices')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 278, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_26._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'ExternalResources')), pyxb.utils.utility.Location('/tmp/user/71303/tmpzSiXrjxsds/PacBioBaseDataModel.xsd', 289, 5))
    st_2 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    transitions = []
    transitions.append(fac.Transition(st_0, [
