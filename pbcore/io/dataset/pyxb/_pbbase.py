...
# Generated 2019-01-03 14:03:29.643363 by PyXB version 1.2.4 using Python 2.7.9.final.0
...
class STD_ANON (pyxb.binding.datatypes.dateTime):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 140, 3)
    _Documentation = None
...
class STD_ANON_ (pyxb.binding.datatypes.dateTime):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 148, 3)
    _Documentation = None
...
class STD_ANON_2 (pyxb.binding.datatypes.string):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 163, 5)
    _Documentation = None
...
class STD_ANON_3 (pyxb.binding.datatypes.string):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 260, 20)
    _Documentation = None
...
class SupportedAcquisitionStates (pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 787, 1)
    _Documentation = None
...
class SupportedDataTypes (pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 817, 1)
    _Documentation = None
...
class SupportedNucleotides (pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 859, 1)
    _Documentation = None
...
class SupportedRunStates (pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 867, 1)
    _Documentation = None
...
class SupportedChipTypes (pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 883, 1)
    _Documentation = None
...
class SupportedFilterOperators (pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 902, 1)
    _Documentation = None
...
class SupportedFilterNames (pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 923, 1)
    _Documentation = None
...
class SupportedHashAlgorithms (pyxb.binding.datatypes.string, pyxb.binding.basis.enumeration_mixin):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 950, 1)
    _Documentation = None
...
class CTD_ANON (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 14, 6)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://pacificbiosciences.com/PacBioBaseDataModel.xsd}Values uses Python identifier Values
    __Values = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'Values'), 'Values', '__httppacificbiosciences_comPacBioBaseDataModel_xsd_CTD_ANON_httppacificbiosciences_comPacBioBaseDataModel_xsdValues', False, pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 16, 8), )
    ...
    __NumberFilterBins._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 29, 7)
    __NumberFilterBins._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 29, 7)
...
class CTD_ANON_ (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 17, 9)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://pacificbiosciences.com/PacBioBaseDataModel.xsd}Value uses Python identifier Value
    __Value = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'Value'), 'Value', '__httppacificbiosciences_comPacBioBaseDataModel_xsd_CTD_ANON__httppacificbiosciences_comPacBioBaseDataModel_xsdValue', True, pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 19, 11), )
...
class CTD_ANON_6 (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 320, 6)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
...
class CTD_ANON_7 (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 393, 6)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://pacificbiosciences.com/PacBioBaseDataModel.xsd}Automation uses Python identifier Automation
    __Automation = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'Automation'), 'Automation', '__httppacificbiosciences_comPacBioBaseDataModel_xsd_CTD_ANON_7_httppacificbiosciences_comPacBioBaseDataModel_xsdAutomation', True, pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 395, 8), )
...
class CTD_ANON_9 (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 526, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
...
class CTD_ANON_10 (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 540, 6)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://pacificbiosciences.com/PacBioBaseDataModel.xsd}Analog uses Python identifier Analog
    __Analog = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'Analog'), 'Analog', '__httppacificbiosciences_comPacBioBaseDataModel_xsd_CTD_ANON_10_httppacificbiosciences_comPacBioBaseDataModel_xsdAnalog', True, pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 542, 8), )
...
class CTD_ANON_11 (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 557, 6)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __SNR_A._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 558, 7)
    __SNR_A._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 558, 7)
    ...
    __SNR_C._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 559, 7)
    __SNR_C._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 559, 7)
    ...
    __SNR_G._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 560, 7)
    __SNR_G._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 560, 7)
    ...
    __SNR_T._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 561, 7)
    __SNR_T._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 561, 7)
...
class CTD_ANON_12 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __NumberFilterBins._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 590, 16)
    __NumberFilterBins._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 590, 16)
...
class CTD_ANON_13 (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 576, 24)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://pacificbiosciences.com/PacBioBaseDataModel.xsd}Value uses Python identifier Value
    __Value = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'Value'), 'Value', '__httppacificbiosciences_comPacBioBaseDataModel_xsd_CTD_ANON_13_httppacificbiosciences_comPacBioBaseDataModel_xsdValue', True, pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 578, 32), )
...
class CTD_ANON_15 (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 646, 6)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://pacificbiosciences.com/PacBioBaseDataModel.xsd}BinCount uses Python identifier BinCount
    __BinCount = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'BinCount'), 'BinCount', '__httppacificbiosciences_comPacBioBaseDataModel_xsd_CTD_ANON_15_httppacificbiosciences_comPacBioBaseDataModel_xsdBinCount', True, pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 648, 8), )
...
class CTD_ANON_17 (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 676, 6)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://pacificbiosciences.com/PacBioBaseDataModel.xsd}Val uses Python identifier Val
    __Val = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'Val'), 'Val', '__httppacificbiosciences_comPacBioBaseDataModel_xsd_CTD_ANON_17_httppacificbiosciences_comPacBioBaseDataModel_xsdVal', True, pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 678, 8), )
...
class KeyValueMap_ (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 994, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://pacificbiosciences.com/PacBioBaseDataModel.xsd}Items uses Python identifier Items
    __Items = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'Items'), 'Items', '__httppacificbiosciences_comPacBioBaseDataModel_xsd_KeyValueMap__httppacificbiosciences_comPacBioBaseDataModel_xsdItems', False, pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 996, 3), )
...
class CTD_ANON_19 (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 997, 4)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://pacificbiosciences.com/PacBioBaseDataModel.xsd}Item uses Python identifier Item
    __Item = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'Item'), 'Item', '__httppacificbiosciences_comPacBioBaseDataModel_xsd_CTD_ANON_19_httppacificbiosciences_comPacBioBaseDataModel_xsdItem', True, pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 999, 6), )
...
class MapItemType (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 1014, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://pacificbiosciences.com/PacBioBaseDataModel.xsd}Key uses Python identifier Key
    __Key = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'Key'), 'Key', '__httppacificbiosciences_comPacBioBaseDataModel_xsd_MapItemType_httppacificbiosciences_comPacBioBaseDataModel_xsdKey', False, pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 1016, 3), )
    ...
    # Element {http://pacificbiosciences.com/PacBioBaseDataModel.xsd}Value uses Python identifier Value
    __Value = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'Value'), 'Value', '__httppacificbiosciences_comPacBioBaseDataModel_xsd_MapItemType_httppacificbiosciences_comPacBioBaseDataModel_xsdValue', False, pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 1017, 3), )
...
class DefaultsType (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 1027, 4)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
...
class CTD_ANON_20 (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 1033, 16)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
...
class BaseEntityType (pyxb.binding.basis.complexTypeDefinition):
    ...
    __Name._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 106, 2)
    __Name._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 106, 2)
    ...
    __Description._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 111, 2)
    __Description._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 111, 2)
    ...
    __Tags._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 116, 2)
    __Tags._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 116, 2)
    ...
    __Format._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 121, 2)
    __Format._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 121, 2)
    ...
    __ResourceId._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 126, 2)
    __ResourceId._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 126, 2)
    ...
    __Version._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 131, 2)
    __Version._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 131, 2)
    ...
    __CreatedAt._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 136, 2)
    __CreatedAt._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 136, 2)
    ...
    __ModifiedAt._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 144, 2)
    __ModifiedAt._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 144, 2)
...
class CTD_ANON_22 (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 962, 7)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __Name._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 963, 8)
    __Name._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 963, 8)
    ...
    __Value._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 964, 8)
    __Value._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 964, 8)
    ...
    __Operator._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 965, 8)
    __Operator._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 965, 8)
    ...
    __Hash._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 966, 8)
    __Hash._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 966, 8)
    ...
    __Modulo._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 971, 8)
    __Modulo._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 971, 8)
    ...
    __Feature._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 972, 8)
    __Feature._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 972, 8)
    ...
    __Assignment._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 973, 8)
    __Assignment._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 973, 8)
...
class AnalogType (BaseEntityType):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 6, 1)
    ...
    __Base._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 65, 4)
    __Base._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 65, 4)
    ...
    __Nucleotide._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 70, 4)
    __Nucleotide._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 70, 4)
    ...
    __Wavelength._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 75, 4)
    __Wavelength._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 75, 4)
    ...
    __CompoundID._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 80, 4)
    __CompoundID._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 80, 4)
    ...
    __LotID._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 85, 4)
    __LotID._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 85, 4)
...
class StrictEntityType (BaseEntityType):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 153, 1)
    _ElementMap = BaseEntityType._ElementMap.copy()
    _AttributeMap = BaseEntityType._AttributeMap.copy()
    # Base type is BaseEntityType
    ...
    __UniqueId._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 159, 4)
    __UniqueId._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 159, 4)
    ...
    __MetaType._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 170, 4)
    __MetaType._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 170, 4)
    ...
    __TimeStampedName._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 175, 4)
    __TimeStampedName._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 175, 4)
...
class DataEntityType (BaseEntityType):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 194, 1)
    _ElementMap = BaseEntityType._ElementMap.copy()
    _AttributeMap = BaseEntityType._AttributeMap.copy()
    # Base type is BaseEntityType
    ...
    __ValueDataType._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 212, 4)
    __ValueDataType._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 212, 4)
    ...
    __SimpleValue._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 217, 4)
    __SimpleValue._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 217, 4)
    ...
    __MetaType._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 222, 4)
    __MetaType._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 222, 4)
    ...
    __TimeStampedName._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 227, 4)
    __TimeStampedName._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 227, 4)
...
class DNABarcode (BaseEntityType):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 245, 1)
    _ElementMap = BaseEntityType._ElementMap.copy()
    _AttributeMap = BaseEntityType._AttributeMap.copy()
    # Base type is BaseEntityType
    ...
    __DNASequence._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 251, 4)
    __DNASequence._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 251, 4)
    ...
    __UniqueId._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 256, 16)
    __UniqueId._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 256, 16)
...
class AutomationType (BaseEntityType):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 315, 1)
    _ElementMap = BaseEntityType._ElementMap.copy()
    _AttributeMap = BaseEntityType._AttributeMap.copy()
    # Base type is BaseEntityType
    ...
    __PartNumber._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 328, 4)
    __PartNumber._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 328, 4)
    ...
    __IsRestricted._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 333, 4)
    __IsRestricted._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 333, 4)
    ...
    __IsObsolete._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 338, 4)
    __IsObsolete._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 338, 4)
    ...
    __ChipType._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 343, 5)
    __ChipType._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 343, 5)
    ...
    __IsDefault._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 348, 4)
    __IsDefault._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 348, 4)
...
By default, any PN is compatible for use with other PNs in the system.  In order to exclude the usage of one or more PNs with this one, the pairwise incompatible PNs are listed here."""
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 361, 1)
    _ElementMap = BaseEntityType._ElementMap.copy()
    _AttributeMap = BaseEntityType._AttributeMap.copy()
    # Base type is BaseEntityType
    ...
    __PartA._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 369, 4)
    __PartA._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 369, 4)
    ...
    __PartB._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 374, 4)
    __PartB._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 374, 4)
...
class AutomationConstraintType (BaseEntityType):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 382, 1)
    _ElementMap = BaseEntityType._ElementMap.copy()
    _AttributeMap = BaseEntityType._AttributeMap.copy()
    # Base type is BaseEntityType
    ...
    __SupportsCellReuse._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 400, 4)
    __SupportsCellReuse._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 400, 4)
    ...
    __SupportsStageStart._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 405, 4)
    __SupportsStageStart._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 405, 4)
    ...
    __MaxCollectionsPerCell._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 410, 4)
    __MaxCollectionsPerCell._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 410, 4)
    ...
    __MinMovieLength._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 415, 4)
    __MinMovieLength._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 415, 4)
    ...
    __MaxMovieLength._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 420, 4)
    __MaxMovieLength._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 420, 4)
    ...
    __MinInsertSize._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 425, 4)
    __MinInsertSize._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 425, 4)
    ...
    __MaxInsertSize._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 430, 4)
    __MaxInsertSize._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 430, 4)
    ...
    __ChipType._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 435, 4)
    __ChipType._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 435, 4)
...
class CTD_ANON_23 (BaseEntityType):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 502, 6)
    _ElementMap = BaseEntityType._ElementMap.copy()
    _AttributeMap = BaseEntityType._AttributeMap.copy()
    # Base type is BaseEntityType
...
class StatsContinuousDistType (BaseEntityType):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 606, 1)
    _ElementMap = BaseEntityType._ElementMap.copy()
    _AttributeMap = BaseEntityType._AttributeMap.copy()
    # Base type is BaseEntityType
    ...
    __Channel._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 633, 4)
    __Channel._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 633, 4)
...
class StatsDiscreteDistType (BaseEntityType):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 637, 1)
    _ElementMap = BaseEntityType._ElementMap.copy()
    _AttributeMap = BaseEntityType._AttributeMap.copy()
    # Base type is BaseEntityType
...
class StatsTimeSeriesType (BaseEntityType):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 664, 1)
    _ElementMap = BaseEntityType._ElementMap.copy()
    _AttributeMap = BaseEntityType._AttributeMap.copy()
    # Base type is BaseEntityType
...
class CTD_ANON_24 (AnalogType):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 187, 2)
...
class CTD_ANON_25 (AnalogType):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 274, 2)
    _ElementMap = AnalogType._ElementMap.copy()
    _AttributeMap = AnalogType._AttributeMap.copy()
    # Base type is AnalogType
...
class InputOutputDataType (StrictEntityType):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 290, 1)
...
If the part number has an NFC associated with it, the contents of the NFC may be encoded here."""
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 443, 1)
    ...
    __PartNumber._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 454, 4)
    __PartNumber._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 454, 4)
    ...
    __LotNumber._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 459, 4)
    __LotNumber._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 459, 4)
    ...
    __Barcode._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 464, 4)
    __Barcode._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 464, 4)
    ...
    __ExpirationDate._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 469, 4)
    __ExpirationDate._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 469, 4)
    ...
    __IsObsolete._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 474, 4)
    __IsObsolete._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 474, 4)
    ...
    __IsRestricted._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 475, 4)
    __IsRestricted._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 475, 4)
    ...
    __ChipType._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 476, 4)
    __ChipType._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 476, 4)
...
class RecordedEventType (DataEntityType):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 480, 1)
    _ElementMap = DataEntityType._ElementMap.copy()
    _AttributeMap = DataEntityType._AttributeMap.copy()
    # Base type is DataEntityType
    ...
    __Context._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 486, 4)
    __Context._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 486, 4)
...
class SequencingChemistry (DataEntityType):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 494, 1)
    _ElementMap = DataEntityType._ElementMap.copy()
    _AttributeMap = DataEntityType._AttributeMap.copy()
    # Base type is DataEntityType
...
class SequencingChemistryConfig (DataEntityType):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 532, 1)
    _ElementMap = DataEntityType._ElementMap.copy()
    _AttributeMap = DataEntityType._AttributeMap.copy()
    # Base type is DataEntityType
...
class IndexedDataType (InputOutputDataType):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 295, 1)
...
class SupplyKitBinding (PartNumberType):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 686, 1)
...
class SupplyKitCellPack (PartNumberType):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 707, 1)
    _ElementMap = PartNumberType._ElementMap.copy()
    _AttributeMap = PartNumberType._AttributeMap.copy()
    # Base type is PartNumberType
    ...
    __SupportsCellReuse._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 720, 4)
    __SupportsCellReuse._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 720, 4)
    ...
    __MovieTimeGrade._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 725, 4)
    __MovieTimeGrade._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 725, 4)
...
class SupplyKitControl (PartNumberType):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 733, 1)
    _ElementMap = PartNumberType._ElementMap.copy()
    _AttributeMap = PartNumberType._AttributeMap.copy()
    # Base type is PartNumberType
...
class SupplyKitTemplate (PartNumberType):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 750, 1)
    _ElementMap = PartNumberType._ElementMap.copy()
    _AttributeMap = PartNumberType._AttributeMap.copy()
    # Base type is PartNumberType
    ...
    __MinInsertSize._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 774, 4)
    __MinInsertSize._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 774, 4)
    ...
    __MaxInsertSize._DeclarationLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 779, 4)
    __MaxInsertSize._UseLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 779, 4)
...
class CTD_ANON_26 (IndexedDataType):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 985, 2)
...
ExtensionElement = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ExtensionElement'), pyxb.binding.datatypes.anyType, documentation='A generic element whose contents are undefined at the schema level.  This is used to extend the data model.', location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 897, 1))
Namespace.addCategoryObject('elementBinding', ExtensionElement.name().localName(), ExtensionElement)

DataPointers = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'DataPointers'), CTD_ANON_3, documentation='Pointer list to UniqueIds in the system', location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 235, 1))
Namespace.addCategoryObject('elementBinding', DataPointers.name().localName(), DataPointers)

ExternalResources = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ExternalResources'), CTD_ANON_4, documentation='Pointers to data that do not reside inside the parent structure', location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 280, 1))
Namespace.addCategoryObject('elementBinding', ExternalResources.name().localName(), ExternalResources)

PacBioSequencingChemistry = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'PacBioSequencingChemistry'), CTD_ANON_9, documentation='Root element for document containing the container of analog set, SequencingChemistryConfig', location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 522, 1))
Namespace.addCategoryObject('elementBinding', PacBioSequencingChemistry.name().localName(), PacBioSequencingChemistry)

ValueDataType = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ValueDataType'), SupportedDataTypes, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 895, 1))
Namespace.addCategoryObject('elementBinding', ValueDataType.name().localName(), ValueDataType)

KeyValueMap = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'KeyValueMap'), KeyValueMap_, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 991, 1))
Namespace.addCategoryObject('elementBinding', KeyValueMap.name().localName(), KeyValueMap)

CellMaxMovieTimes = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'CellMaxMovieTimes'), KeyValueMap_, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 992, 1))
...
DataEntity = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'DataEntity'), DataEntityType, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 193, 1))
Namespace.addCategoryObject('elementBinding', DataEntity.name().localName(), DataEntity)

AutomationParameter = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'AutomationParameter'), DataEntityType, documentation='One or more collection parameters, such as MovieLength, InsertSize, UseStageStart, IsControl, etc..', location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 356, 1))
Namespace.addCategoryObject('elementBinding', AutomationParameter.name().localName(), AutomationParameter)

ConfigSetAnalog = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ConfigSetAnalog'), CTD_ANON_24, documentation='An unlimited number of analogs listed for the purposes of hosting in a configuration file. e.g. a list of all possible analogs on the system', location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 183, 1))
Namespace.addCategoryObject('elementBinding', ConfigSetAnalog.name().localName(), ConfigSetAnalog)

DyeSetAnalog = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'DyeSetAnalog'), CTD_ANON_25, documentation='A set of four analogs, one for each of the nucleotides, grouped together for the purposes of a single experiment.', location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 270, 1))
Namespace.addCategoryObject('elementBinding', DyeSetAnalog.name().localName(), DyeSetAnalog)

ChemistryConfig = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ChemistryConfig'), SequencingChemistryConfig, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 1021, 1))
Namespace.addCategoryObject('elementBinding', ChemistryConfig.name().localName(), ChemistryConfig)

ExternalResource = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ExternalResource'), CTD_ANON_26, documentation='for example, an output file could be the BAM file, which could be associated with multiple indices into it.', location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 981, 1))
Namespace.addCategoryObject('elementBinding', ExternalResource.name().localName(), ExternalResource)



CTD_ANON._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Values'), CTD_ANON_, scope=CTD_ANON, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 16, 8)))
...
def _BuildAutomaton ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Values')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 16, 8))
...
def _BuildAutomaton_ ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Value')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 19, 11))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
...
def _BuildAutomaton_2 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 101, 6))
    counters.add(cc_0)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_2._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'ExtensionElement')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 101, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
CTD_ANON_3._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'DataPointer'), pyxb.binding.datatypes.IDREF, scope=CTD_ANON_3, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 241, 4)))
...
def _BuildAutomaton_3 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 241, 4))
    counters.add(cc_0)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_3._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'DataPointer')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 241, 4))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
CTD_ANON_4._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ExternalResource'), CTD_ANON_26, scope=CTD_ANON_4, documentation='for example, an output file could be the BAM file, which could be associated with multiple indices into it.', location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 981, 1)))
...
def _BuildAutomaton_4 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_4._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'ExternalResource')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 286, 4))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
CTD_ANON_5._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'FileIndex'), InputOutputDataType, scope=CTD_ANON_5, documentation='e.g. index for output files, allowing one to find information in the output file', location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 302, 8)))
...
def _BuildAutomaton_5 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_5._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'FileIndex')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 302, 8))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
def _BuildAutomaton_6 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_6._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'AutomationParameter')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 322, 8))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
CTD_ANON_7._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Automation'), AutomationType, scope=CTD_ANON_7, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 395, 8)))
...
def _BuildAutomaton_7 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_7._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Automation')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 395, 8))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
CTD_ANON_8._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Analog'), AnalogType, scope=CTD_ANON_8, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 509, 13)))
...
def _BuildAutomaton_8 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=1, max=4, metadata=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 509, 13))
    counters.add(cc_0)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_8._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Analog')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 509, 13))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
CTD_ANON_9._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ChemistryConfig'), SequencingChemistryConfig, scope=CTD_ANON_9, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 1021, 1)))
...
def _BuildAutomaton_9 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_9._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'ChemistryConfig')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 528, 4))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    st_0._set_transitionSet(transitions)
...
CTD_ANON_10._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Analog'), AnalogType, scope=CTD_ANON_10, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 542, 8)))
...
def _BuildAutomaton_10 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=1, max=4, metadata=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 542, 8))
    counters.add(cc_0)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_10._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Analog')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 542, 8))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
CTD_ANON_12._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Values'), CTD_ANON_13, scope=CTD_ANON_12, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 575, 20)))
...
def _BuildAutomaton_11 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_12._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Values')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 575, 20))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    st_0._set_transitionSet(transitions)
...
def _BuildAutomaton_12 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_13._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Value')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 578, 32))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
CTD_ANON_14._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'BinCount'), pyxb.binding.datatypes.int, scope=CTD_ANON_14, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 622, 8)))
...
def _BuildAutomaton_13 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_14._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'BinCount')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 622, 8))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
CTD_ANON_15._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'BinCount'), pyxb.binding.datatypes.int, scope=CTD_ANON_15, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 648, 8)))
...
def _BuildAutomaton_14 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_15._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'BinCount')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 648, 8))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
CTD_ANON_16._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'BinLabel'), pyxb.binding.datatypes.string, scope=CTD_ANON_16, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 656, 8)))
...
def _BuildAutomaton_15 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_16._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'BinLabel')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 656, 8))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
CTD_ANON_17._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Val'), pyxb.binding.datatypes.float, scope=CTD_ANON_17, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 678, 8)))
...
def _BuildAutomaton_16 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 678, 8))
    counters.add(cc_0)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_17._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Val')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 678, 8))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
UserDefinedFieldsType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'DataEntities'), DataEntityType, scope=UserDefinedFieldsType, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 892, 3)))
...
def _BuildAutomaton_17 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(UserDefinedFieldsType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'DataEntities')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 892, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
FilterType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Properties'), CTD_ANON_18, scope=FilterType, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 958, 3)))
...
def _BuildAutomaton_18 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(FilterType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Properties')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 958, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    st_0._set_transitionSet(transitions)
...
CTD_ANON_18._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Property'), CTD_ANON_22, scope=CTD_ANON_18, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 961, 6)))
...
def _BuildAutomaton_19 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_18._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Property')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 961, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
KeyValueMap_._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Items'), CTD_ANON_19, scope=KeyValueMap_, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 996, 3)))
...
def _BuildAutomaton_20 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(KeyValueMap_._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Items')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 996, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    st_0._set_transitionSet(transitions)
...
CTD_ANON_19._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Item'), MapItemType, scope=CTD_ANON_19, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 999, 6)))
...
def _BuildAutomaton_21 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 999, 6))
    counters.add(cc_0)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_19._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Item')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 999, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
MapType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'KeyValueMap'), KeyValueMap_, scope=MapType, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 1011, 3)))
...
def _BuildAutomaton_22 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(MapType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'KeyValueMap')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 1011, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    st_0._set_transitionSet(transitions)
...
MapItemType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Key'), pyxb.binding.datatypes.string, scope=MapItemType, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 1016, 3)))

MapItemType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Value'), pyxb.binding.datatypes.anyType, scope=MapItemType, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 1017, 3)))

MapItemType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Description'), pyxb.binding.datatypes.string, scope=MapItemType, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 1018, 3)))
...
def _BuildAutomaton_23 ():
    ...
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(MapItemType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Key')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 1016, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(MapItemType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Value')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 1017, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(MapItemType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Description')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 1018, 3))
...
DefaultsType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'AutomationParameters'), CTD_ANON_20, nillable=pyxb.binding.datatypes.boolean(1), scope=DefaultsType, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 1032, 12)))

DefaultsType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Filters'), CTD_ANON_21, nillable=pyxb.binding.datatypes.boolean(1), scope=DefaultsType, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 1039, 12)))
...
def _BuildAutomaton_24 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 1032, 12))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 1039, 12))
    counters.add(cc_1)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(DefaultsType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'AutomationParameters')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 1032, 12))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(DefaultsType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Filters')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 1039, 12))
...
def _BuildAutomaton_25 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_20._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'AutomationParameter')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 1035, 24))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
CTD_ANON_21._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Filter'), FilterType, scope=CTD_ANON_21, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 1042, 24)))
...
def _BuildAutomaton_26 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_21._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Filter')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 1042, 24))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
BaseEntityType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Extensions'), CTD_ANON_2, scope=BaseEntityType, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 98, 3)))
...
def _BuildAutomaton_27 ():
    ...
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(BaseEntityType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Extensions')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 98, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
AnalogType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Spectrum'), CTD_ANON, scope=AnalogType, documentation='A vector of probabilities, given in the order of increasing filter-bin wavelength, that light emitted by the analog will fall in the corresponding filter bin of the instrument detection system. By convention, the values are normalized to sum to 1.', location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 10, 5)))

AnalogType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'RelativeAmplitude'), pyxb.binding.datatypes.float, scope=AnalogType, documentation='Relative intensity of emission vs. a reference analog using standardized metrology \u2013 e.g., relative to the amplitude of the \u201c542\u201d analog as measured by the mean DWS pkMid on the Astro instrument.', location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 36, 5)))

AnalogType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'IntraPulseXsnCV'), pyxb.binding.datatypes.float, scope=AnalogType, documentation='The 1-sigma fractional variation of the intra-pulse signal, independent of any Shot noise associated with that signal', location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 41, 5)))

AnalogType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'InterPulseXsnCV'), pyxb.binding.datatypes.float, scope=AnalogType, documentation='The 1-sigma fractional variation, pulse-to-pulse, of the mean signal level (i.e., the pkMid).', location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 46, 10)))

AnalogType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Pw2SlowStepRatio'), pyxb.binding.datatypes.float, scope=AnalogType, documentation='The pulse-width two slow-step ratio.', location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 51, 10)))

AnalogType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Ipd2SlowStepRatio'), pyxb.binding.datatypes.float, scope=AnalogType, documentation='The inter-pulse distance (IPD) two slow-step ratio.', location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 56, 4)))

AnalogType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'DiffusionXsnCV'), pyxb.binding.datatypes.float, scope=AnalogType, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 61, 10)))

AnalogType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'PulseWidthMeanSeconds'), pyxb.binding.datatypes.float, scope=AnalogType, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 62, 20)))

AnalogType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'IpdMeanSeconds'), pyxb.binding.datatypes.float, scope=AnalogType, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 63, 20)))
...
def _BuildAutomaton_28 ():
    ...
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 98, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 51, 10))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 56, 4))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 62, 20))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 63, 20))
    counters.add(cc_4)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(AnalogType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Extensions')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 98, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(AnalogType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Spectrum')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 10, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(AnalogType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'RelativeAmplitude')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 36, 5))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(AnalogType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'IntraPulseXsnCV')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 41, 5))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(AnalogType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'InterPulseXsnCV')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 46, 10))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(AnalogType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Pw2SlowStepRatio')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 51, 10))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(AnalogType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Ipd2SlowStepRatio')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 56, 4))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(AnalogType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'DiffusionXsnCV')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 61, 10))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(AnalogType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'PulseWidthMeanSeconds')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 62, 20))
    st_8 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(AnalogType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'IpdMeanSeconds')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 63, 20))
...
def _BuildAutomaton_29 ():
    ...
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(StrictEntityType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Extensions')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 98, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
def _BuildAutomaton_30 ():
    ...
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(DataEntityType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Extensions')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 98, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(DataEntityType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'CheckSum')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 206, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
def _BuildAutomaton_31 ():
    ...
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(DNABarcode._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Extensions')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 98, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
AutomationType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'AutomationParameters'), CTD_ANON_6, scope=AutomationType, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 319, 5)))
...
def _BuildAutomaton_32 ():
    ...
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 98, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 319, 5))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 326, 5))
    counters.add(cc_2)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(AutomationType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Extensions')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 98, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(AutomationType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'AutomationParameters')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 319, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(AutomationType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Defaults')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 326, 5))
...
def _BuildAutomaton_33 ():
    ...
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(IncompatiblePairType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Extensions')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 98, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
def _BuildAutomaton_34 ():
    ...
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 98, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 389, 5))
    counters.add(cc_1)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(AutomationConstraintType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Extensions')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 98, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(AutomationConstraintType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Automations')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 389, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
CTD_ANON_23._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Analogs'), CTD_ANON_8, scope=CTD_ANON_23, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 506, 10)))
...
def _BuildAutomaton_35 ():
    ...
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_23._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Extensions')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 98, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_23._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Analogs')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 506, 10))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
StatsContinuousDistType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'SampleSize'), pyxb.binding.datatypes.int, scope=StatsContinuousDistType, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 613, 5)))

StatsContinuousDistType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'SampleMean'), pyxb.binding.datatypes.float, scope=StatsContinuousDistType, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 614, 5)))

StatsContinuousDistType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'SampleMed'), pyxb.binding.datatypes.float, scope=StatsContinuousDistType, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 615, 5)))

StatsContinuousDistType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'SampleStd'), pyxb.binding.datatypes.float, scope=StatsContinuousDistType, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 616, 5)))

StatsContinuousDistType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Sample95thPct'), pyxb.binding.datatypes.float, scope=StatsContinuousDistType, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 617, 5)))

StatsContinuousDistType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'NumBins'), pyxb.binding.datatypes.int, scope=StatsContinuousDistType, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 618, 5)))

StatsContinuousDistType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'BinCounts'), CTD_ANON_14, scope=StatsContinuousDistType, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 619, 5)))

StatsContinuousDistType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'BinWidth'), pyxb.binding.datatypes.float, scope=StatsContinuousDistType, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 626, 5)))

StatsContinuousDistType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'MinOutlierValue'), pyxb.binding.datatypes.float, scope=StatsContinuousDistType, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 627, 5)))

StatsContinuousDistType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'MinBinValue'), pyxb.binding.datatypes.float, scope=StatsContinuousDistType, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 628, 5)))

StatsContinuousDistType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'MaxBinValue'), pyxb.binding.datatypes.float, scope=StatsContinuousDistType, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 629, 5)))

StatsContinuousDistType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'MaxOutlierValue'), pyxb.binding.datatypes.float, scope=StatsContinuousDistType, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 630, 5)))

StatsContinuousDistType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'MetricDescription'), pyxb.binding.datatypes.string, scope=StatsContinuousDistType, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 631, 5)))
...
def _BuildAutomaton_36 ():
    ...
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 98, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 627, 5))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 628, 5))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 629, 5))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 630, 5))
    counters.add(cc_4)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(StatsContinuousDistType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Extensions')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 98, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(StatsContinuousDistType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'SampleSize')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 613, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(StatsContinuousDistType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'SampleMean')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 614, 5))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(StatsContinuousDistType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'SampleMed')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 615, 5))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(StatsContinuousDistType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'SampleStd')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 616, 5))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(StatsContinuousDistType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Sample95thPct')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 617, 5))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(StatsContinuousDistType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'NumBins')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 618, 5))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(StatsContinuousDistType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'BinCounts')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 619, 5))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(StatsContinuousDistType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'BinWidth')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 626, 5))
    st_8 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(StatsContinuousDistType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'MinOutlierValue')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 627, 5))
    st_9 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_9)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(StatsContinuousDistType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'MinBinValue')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 628, 5))
    st_10 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_10)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(StatsContinuousDistType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'MaxBinValue')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 629, 5))
    st_11 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_11)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(StatsContinuousDistType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'MaxOutlierValue')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 630, 5))
    st_12 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_12)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(StatsContinuousDistType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'MetricDescription')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 631, 5))
...
StatsDiscreteDistType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'NumBins'), pyxb.binding.datatypes.int, scope=StatsDiscreteDistType, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 644, 5)))

StatsDiscreteDistType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'BinCounts'), CTD_ANON_15, scope=StatsDiscreteDistType, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 645, 5)))

StatsDiscreteDistType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'MetricDescription'), pyxb.binding.datatypes.string, scope=StatsDiscreteDistType, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 652, 5)))

StatsDiscreteDistType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'BinLabels'), CTD_ANON_16, scope=StatsDiscreteDistType, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 653, 5)))
...
def _BuildAutomaton_37 ():
    ...
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(StatsDiscreteDistType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Extensions')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 98, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(StatsDiscreteDistType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'NumBins')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 644, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(StatsDiscreteDistType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'BinCounts')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 645, 5))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(StatsDiscreteDistType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'MetricDescription')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 652, 5))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(StatsDiscreteDistType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'BinLabels')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 653, 5))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
StatsTimeSeriesType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'TimeUnits'), pyxb.binding.datatypes.string, scope=StatsTimeSeriesType, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 671, 5)))

StatsTimeSeriesType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ValueUnits'), pyxb.binding.datatypes.string, scope=StatsTimeSeriesType, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 672, 5)))

StatsTimeSeriesType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'StartTime'), pyxb.binding.datatypes.float, scope=StatsTimeSeriesType, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 673, 5)))

StatsTimeSeriesType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'MeasInterval'), pyxb.binding.datatypes.float, scope=StatsTimeSeriesType, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 674, 5)))

StatsTimeSeriesType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Values'), CTD_ANON_17, scope=StatsTimeSeriesType, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 675, 5)))
...
def _BuildAutomaton_38 ():
    ...
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 98, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 675, 5))
    counters.add(cc_1)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(StatsTimeSeriesType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Extensions')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 98, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(StatsTimeSeriesType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'TimeUnits')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 671, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(StatsTimeSeriesType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'ValueUnits')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 672, 5))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(StatsTimeSeriesType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'StartTime')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 673, 5))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(StatsTimeSeriesType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'MeasInterval')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 674, 5))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(StatsTimeSeriesType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Values')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 675, 5))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
def _BuildAutomaton_39 ():
    ...
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_24._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Extensions')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 98, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_24._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Spectrum')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 10, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_24._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'RelativeAmplitude')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 36, 5))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_24._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'IntraPulseXsnCV')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 41, 5))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_24._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'InterPulseXsnCV')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 46, 10))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_24._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Pw2SlowStepRatio')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 51, 10))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_24._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Ipd2SlowStepRatio')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 56, 4))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_24._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'DiffusionXsnCV')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 61, 10))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_24._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'PulseWidthMeanSeconds')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 62, 20))
    st_8 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_24._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'IpdMeanSeconds')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 63, 20))
    st_9 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_9)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
def _BuildAutomaton_40 ():
    ...
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_25._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Extensions')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 98, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_25._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Spectrum')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 10, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_25._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'RelativeAmplitude')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 36, 5))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_25._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'IntraPulseXsnCV')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 41, 5))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_25._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'InterPulseXsnCV')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 46, 10))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_25._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Pw2SlowStepRatio')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 51, 10))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_25._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Ipd2SlowStepRatio')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 56, 4))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_25._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'DiffusionXsnCV')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 61, 10))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_25._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'PulseWidthMeanSeconds')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 62, 20))
    st_8 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_25._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'IpdMeanSeconds')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 63, 20))
    st_9 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_9)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
def _BuildAutomaton_41 ():
    ...
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(InputOutputDataType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Extensions')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 98, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
def _BuildAutomaton_42 ():
    ...
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(PartNumberType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Extensions')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 98, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(PartNumberType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'CheckSum')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 206, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(PartNumberType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Defaults')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 452, 5))
    st_2 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
def _BuildAutomaton_43 ():
    ...
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(RecordedEventType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Extensions')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 98, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(RecordedEventType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'CheckSum')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 206, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
SequencingChemistry._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'DyeSet'), CTD_ANON_23, scope=SequencingChemistry, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 501, 5)))
...
def _BuildAutomaton_44 ():
    ...
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(SequencingChemistry._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Extensions')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 98, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(SequencingChemistry._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'CheckSum')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 206, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(SequencingChemistry._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'DyeSet')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 501, 5))
    st_2 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
SequencingChemistryConfig._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Analogs'), CTD_ANON_10, scope=SequencingChemistryConfig, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 539, 5)))

SequencingChemistryConfig._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'DefaultLaserSetPoint'), pyxb.binding.datatypes.float, scope=SequencingChemistryConfig, documentation="The laser power at the input couple, needed to achieve predefined performance requirements based on a median 'golden' SMRT Cell.", location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 546, 5)))

SequencingChemistryConfig._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'SNRCut'), pyxb.binding.datatypes.float, scope=SequencingChemistryConfig, documentation='The SNRCut is applied in PPA (baz2bam) as a read-quality filter.', location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 551, 5)))

SequencingChemistryConfig._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'TargetSNR'), CTD_ANON_11, scope=SequencingChemistryConfig, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 556, 5)))

SequencingChemistryConfig._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ReferenceSnr'), pyxb.binding.datatypes.float, scope=SequencingChemistryConfig, documentation='The nominal or default SNR of the reference analog under the chemistry and detection configuration.', location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 564, 20)))

SequencingChemistryConfig._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ReferenceSpectrum'), CTD_ANON_12, scope=SequencingChemistryConfig, documentation='The nominal or default spectrum of the reference analog under the chemistry and detection configuration. The spectrum is a vector of probabilities, given in the order of increasing filter-bin wavelength, that light emitted by the analog will fall in the corresponding filter bin of the instrument detection system. By convention, the values are normalized to sum to 1.', location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 569, 8)))

SequencingChemistryConfig._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'EffectiveLoadingPercent'), pyxb.binding.datatypes.float, scope=SequencingChemistryConfig, documentation='The largest conceivable loading percentage for this chemistry.', location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 597, 5)))
...
def _BuildAutomaton_45 ():
    ...
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 206, 5))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 597, 5))
    counters.add(cc_2)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(SequencingChemistryConfig._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Extensions')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 98, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(SequencingChemistryConfig._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'CheckSum')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 206, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(SequencingChemistryConfig._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Analogs')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 539, 5))
    st_2 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(SequencingChemistryConfig._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'DefaultLaserSetPoint')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 546, 5))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(SequencingChemistryConfig._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'SNRCut')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 551, 5))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(SequencingChemistryConfig._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'TargetSNR')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 556, 5))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(SequencingChemistryConfig._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'ReferenceSnr')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 564, 20))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(SequencingChemistryConfig._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'ReferenceSpectrum')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 569, 8))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(SequencingChemistryConfig._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'EffectiveLoadingPercent')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 597, 5))
    st_8 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
IndexedDataType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ExternalResources'), CTD_ANON_4, scope=IndexedDataType, documentation='Pointers to data that do not reside inside the parent structure', location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 280, 1)))

IndexedDataType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'FileIndices'), CTD_ANON_5, scope=IndexedDataType, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 299, 5)))
...
def _BuildAutomaton_46 ():
    ...
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 98, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 299, 5))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 310, 5))
    counters.add(cc_2)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(IndexedDataType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Extensions')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 98, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(IndexedDataType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'FileIndices')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 299, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(IndexedDataType._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'ExternalResources')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 310, 5))
    st_2 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
SupplyKitBinding._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'Control'), SupplyKitControl, scope=SupplyKitBinding, documentation='Defines the binding kit internal control name.  Present when used, otherwise not used if not defined. ', location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 693, 5)))

SupplyKitBinding._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'IsControlUsed'), pyxb.binding.datatypes.boolean, scope=SupplyKitBinding, documentation='True if the control was used during run, otherwise false. ', location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 698, 5)))
...
def _BuildAutomaton_47 ():
    ...
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 452, 5))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 693, 5))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 698, 5))
    counters.add(cc_4)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(SupplyKitBinding._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Extensions')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 98, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(SupplyKitBinding._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'CheckSum')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 206, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(SupplyKitBinding._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Defaults')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 452, 5))
    st_2 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(SupplyKitBinding._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Control')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 693, 5))
    st_3 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(SupplyKitBinding._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'IsControlUsed')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 698, 5))
...
def _BuildAutomaton_48 ():
    ...
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 452, 5))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 714, 5))
    counters.add(cc_3)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(SupplyKitCellPack._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Extensions')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 98, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(SupplyKitCellPack._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'CheckSum')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 206, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(SupplyKitCellPack._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Defaults')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 452, 5))
    st_2 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(SupplyKitCellPack._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'ChipLayout')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 714, 5))
    st_3 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
SupplyKitControl._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'InternalControlName'), pyxb.binding.datatypes.string, scope=SupplyKitControl, documentation='Defines the internal control name, if any. ', location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 740, 5)))

SupplyKitControl._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'CustomSequence'), pyxb.binding.datatypes.string, nillable=pyxb.binding.datatypes.boolean(1), scope=SupplyKitControl, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 745, 5)))
...
def _BuildAutomaton_49 ():
    ...
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 452, 5))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 740, 5))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 745, 5))
    counters.add(cc_4)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(SupplyKitControl._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Extensions')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 98, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(SupplyKitControl._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'CheckSum')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 206, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(SupplyKitControl._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Defaults')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 452, 5))
    st_2 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(SupplyKitControl._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'InternalControlName')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 740, 5))
    st_3 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(SupplyKitControl._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'CustomSequence')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 745, 5))
    st_4 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
SupplyKitTemplate._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'LeftAdaptorSequence'), pyxb.binding.datatypes.string, scope=SupplyKitTemplate, documentation='Left adapter DNA sequence.', location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 757, 5)))

SupplyKitTemplate._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'LeftPrimerSequence'), pyxb.binding.datatypes.string, scope=SupplyKitTemplate, location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 762, 5)))

SupplyKitTemplate._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'RightAdaptorSequence'), pyxb.binding.datatypes.string, scope=SupplyKitTemplate, documentation='Right adapter DNA sequence.  If not specified, a symmetric adapter model is inferred, where the left adapter sequence is used wherever needed.', location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 763, 5)))

SupplyKitTemplate._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'RightPrimerSequence'), pyxb.binding.datatypes.string, scope=SupplyKitTemplate, documentation='Right primaer sequence.  If not specified, a symmetric model is inferred, where the left primer sequence is used wherever needed.', location=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 768, 5)))
...
def _BuildAutomaton_50 ():
    ...
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 452, 5))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 757, 5))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 762, 5))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 763, 5))
    counters.add(cc_5)
    cc_6 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 768, 5))
    counters.add(cc_6)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(SupplyKitTemplate._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Extensions')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 98, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(SupplyKitTemplate._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'CheckSum')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 206, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(SupplyKitTemplate._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Defaults')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 452, 5))
    st_2 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(SupplyKitTemplate._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'LeftAdaptorSequence')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 757, 5))
    st_3 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(SupplyKitTemplate._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'LeftPrimerSequence')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 762, 5))
    st_4 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_5, False))
    symbol = pyxb.binding.content.ElementUse(SupplyKitTemplate._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'RightAdaptorSequence')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 763, 5))
    st_5 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_6, False))
    symbol = pyxb.binding.content.ElementUse(SupplyKitTemplate._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'RightPrimerSequence')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 768, 5))
...
def _BuildAutomaton_51 ():
    ...
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_26._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'Extensions')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 98, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_26._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'FileIndices')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 299, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(CTD_ANON_26._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'ExternalResources')), pyxb.utils.utility.Location('/tmp/tmp_Hqn8Lxsds/PacBioBaseDataModel.xsd', 310, 5))
    st_2 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    transitions = []
    transitions.append(fac.Transition(st_0, [
